...
namespace Vapi\ProviderResources\Requests;

use DateTime;
use Vapi\Core\Json\JsonSerializableType;
use Vapi\ProviderResources\Types\ProviderResourcesListRequestSortOrder;

final class ProviderResourcesListRequest extends JsonSerializableType
{
    /**
     * @var ?string $id
     */
    ...
    /**
     * @var ?value-of<ProviderResourcesListRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
     ...
     *   resourceId?: ?string,
     *   page?: ?float,
     *   sortOrder?: ?value-of<ProviderResourcesListRequestSortOrder>,
     *   limit?: ?float,
