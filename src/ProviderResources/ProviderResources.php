...
use Vapi\ProviderResources\Requests\ProviderResourcesListRequest;
use Vapi\Types\ProviderResource;
use Vapi\Types\ProviderResourcePaginatedResponse;

final readonly class ProviderResources
{
    /**
     * @var array{
     *   baseUrl?: string,
     ...
     * @param ProviderResourcesListRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(string $provider, string $resourceName, ProviderResourcesListRequest $request = new ProviderResourcesListRequest(), ?array $options = null): ProviderResourcePaginatedResponse
    {
     ...
     * @throws VapiApiException
     */
    public function create(string $provider, string $resourceName, ?array $options = null): ProviderResource
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws VapiApiException
     */
    public function get(string $provider, string $resourceName, string $id, ?array $options = null): ProviderResource
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws VapiApiException
     */
    public function delete(string $provider, string $resourceName, string $id, ?array $options = null): ProviderResource
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws VapiApiException
     */
    public function update(string $provider, string $resourceName, string $id, ?array $options = null): ProviderResource
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
