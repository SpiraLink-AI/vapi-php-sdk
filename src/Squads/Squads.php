...
final readonly class Squads
{
    ...
    /**
     * @param SquadsListRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(SquadsListRequest $request = new SquadsListRequest(), ?array $options = null): array
    {
