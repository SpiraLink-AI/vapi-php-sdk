...
final class ToolsCreateResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return ToolsCreateResponse
     */
    public static function dtmf(DtmfTool $dtmf): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ToolsCreateResponse
     */
    public static function endCall(EndCallTool $endCall): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ToolsCreateResponse
     */
    public static function function(FunctionTool $function): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ToolsCreateResponse
     */
    public static function transferCall(TransferCallTool $transferCall): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return ToolsCreateResponse
     */
    public static function handoff(HandoffTool $handoff): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ToolsCreateResponse
     */
    public static function bash(BashTool $bash): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ToolsCreateResponse
     */
    public static function computer(ComputerTool $computer): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ToolsCreateResponse
     */
    public static function textEditor(TextEditorTool $textEditor): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ToolsCreateResponse
     */
    public static function query(QueryTool $query): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ToolsCreateResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function sms(SmsTool $sms): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ToolsCreateResponse
     */
    public static function mcp(McpTool $mcp): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ToolsCreateResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
     ...
     * @return ToolsCreateResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): ToolsCreateResponse
    {
        return new ToolsCreateResponse([
