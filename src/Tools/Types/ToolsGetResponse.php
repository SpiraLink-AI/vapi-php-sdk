...
final class ToolsGetResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return ToolsGetResponse
     */
    public static function dtmf(DtmfTool $dtmf): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ToolsGetResponse
     */
    public static function endCall(EndCallTool $endCall): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ToolsGetResponse
     */
    public static function function(FunctionTool $function): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ToolsGetResponse
     */
    public static function transferCall(TransferCallTool $transferCall): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return ToolsGetResponse
     */
    public static function handoff(HandoffTool $handoff): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ToolsGetResponse
     */
    public static function bash(BashTool $bash): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ToolsGetResponse
     */
    public static function computer(ComputerTool $computer): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ToolsGetResponse
     */
    public static function textEditor(TextEditorTool $textEditor): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ToolsGetResponse
     */
    public static function query(QueryTool $query): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ToolsGetResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function sms(SmsTool $sms): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ToolsGetResponse
     */
    public static function mcp(McpTool $mcp): ToolsGetResponse
    {
        return new ToolsGetResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ToolsGetResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): ToolsGetResponse
    {
        return new ToolsGetResponse([
     ...
     * @return ToolsGetResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): ToolsGetResponse
    {
        return new ToolsGetResponse([
