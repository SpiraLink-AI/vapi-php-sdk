...
final class ToolsDeleteResponse extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(ApiRequestTool $apiRequest): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return ToolsDeleteResponse
     */
    public static function dtmf(DtmfTool $dtmf): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ToolsDeleteResponse
     */
    public static function endCall(EndCallTool $endCall): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ToolsDeleteResponse
     */
    public static function function(FunctionTool $function): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ToolsDeleteResponse
     */
    public static function transferCall(TransferCallTool $transferCall): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return ToolsDeleteResponse
     */
    public static function handoff(HandoffTool $handoff): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ToolsDeleteResponse
     */
    public static function bash(BashTool $bash): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ToolsDeleteResponse
     */
    public static function computer(ComputerTool $computer): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ToolsDeleteResponse
     */
    public static function textEditor(TextEditorTool $textEditor): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ToolsDeleteResponse
     */
    public static function query(QueryTool $query): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ToolsDeleteResponse
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function sms(SmsTool $sms): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ToolsDeleteResponse
     */
    public static function mcp(McpTool $mcp): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ToolsDeleteResponse
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
     ...
     * @return ToolsDeleteResponse
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): ToolsDeleteResponse
    {
        return new ToolsDeleteResponse([
