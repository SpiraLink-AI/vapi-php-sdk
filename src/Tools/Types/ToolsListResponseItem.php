...
final class ToolsListResponseItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return ToolsListResponseItem
     */
    public static function apiRequest(ApiRequestTool $apiRequest): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return ToolsListResponseItem
     */
    public static function dtmf(DtmfTool $dtmf): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ToolsListResponseItem
     */
    public static function endCall(EndCallTool $endCall): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ToolsListResponseItem
     */
    public static function function(FunctionTool $function): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ToolsListResponseItem
     */
    public static function transferCall(TransferCallTool $transferCall): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'transferCall',
            'value' => $transferCall,
     ...
     * @return ToolsListResponseItem
     */
    public static function handoff(HandoffTool $handoff): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ToolsListResponseItem
     */
    public static function bash(BashTool $bash): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ToolsListResponseItem
     */
    public static function computer(ComputerTool $computer): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ToolsListResponseItem
     */
    public static function textEditor(TextEditorTool $textEditor): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ToolsListResponseItem
     */
    public static function query(QueryTool $query): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ToolsListResponseItem
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventTool $googleCalendarEventCreate): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function googleSheetsRowAppend(GoogleSheetsRowAppendTool $googleSheetsRowAppend): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool $googleCalendarAvailabilityCheck): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function slackMessageSend(SlackSendMessageTool $slackMessageSend): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function sms(SmsTool $sms): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ToolsListResponseItem
     */
    public static function mcp(McpTool $mcp): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ToolsListResponseItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool $gohighlevelCalendarAvailabilityCheck): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool $gohighlevelCalendarEventCreate): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function gohighlevelContactCreate(GoHighLevelContactCreateTool $gohighlevelContactCreate): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
     ...
     * @return ToolsListResponseItem
     */
    public static function gohighlevelContactGet(GoHighLevelContactGetTool $gohighlevelContactGet): ToolsListResponseItem
    {
        return new ToolsListResponseItem([
