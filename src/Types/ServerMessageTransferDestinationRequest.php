...
final class ServerMessageTransferDestinationRequest extends JsonSerializableType
{
    /**
     * @var ?ServerMessageTransferDestinationRequestPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
