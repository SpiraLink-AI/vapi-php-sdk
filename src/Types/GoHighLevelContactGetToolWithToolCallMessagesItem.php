...
final class GoHighLevelContactGetToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelContactGetToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelContactGetToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactGetToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelContactGetToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelContactGetToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactGetToolWithToolCallMessagesItem([
     ...
     * @return GoHighLevelContactGetToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelContactGetToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactGetToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelContactGetToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelContactGetToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactGetToolWithToolCallMessagesItem([
