...
final class TwilioPhoneNumberHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return TwilioPhoneNumberHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): TwilioPhoneNumberHooksItem
    {
        return new TwilioPhoneNumberHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return TwilioPhoneNumberHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): TwilioPhoneNumberHooksItem
    {
        return new TwilioPhoneNumberHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
