...
final class UpdateSlackSendMessageToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateSlackSendMessageToolDtoMessagesItem
    {
        return new UpdateSlackSendMessageToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateSlackSendMessageToolDtoMessagesItem
    {
        return new UpdateSlackSendMessageToolDtoMessagesItem([
     ...
     * @return UpdateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateSlackSendMessageToolDtoMessagesItem
    {
        return new UpdateSlackSendMessageToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateSlackSendMessageToolDtoMessagesItem
    {
        return new UpdateSlackSendMessageToolDtoMessagesItem([
