...
final class CreateFunctionToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateFunctionToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateFunctionToolDtoMessagesItem
    {
        return new CreateFunctionToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateFunctionToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateFunctionToolDtoMessagesItem
    {
        return new CreateFunctionToolDtoMessagesItem([
     ...
     * @return CreateFunctionToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateFunctionToolDtoMessagesItem
    {
        return new CreateFunctionToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateFunctionToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateFunctionToolDtoMessagesItem
    {
        return new CreateFunctionToolDtoMessagesItem([
