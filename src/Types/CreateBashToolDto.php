...
final class CreateBashToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateBashToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateBashToolDtoMessagesItem::class])]
