...
final class ServerMessageHang extends JsonSerializableType
{
    /**
     * @var ?ServerMessageHangPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
    #[JsonProperty('phoneNumber')]
    public ?ServerMessageHangPhoneNumber $phoneNumber;
