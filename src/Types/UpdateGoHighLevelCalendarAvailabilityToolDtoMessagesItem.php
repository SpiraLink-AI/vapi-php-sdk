...
final class UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
     ...
     * @return UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
