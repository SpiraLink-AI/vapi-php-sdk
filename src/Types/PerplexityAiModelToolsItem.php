...
final class PerplexityAiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return PerplexityAiModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): PerplexityAiModelToolsItem
    {
        return new PerplexityAiModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
