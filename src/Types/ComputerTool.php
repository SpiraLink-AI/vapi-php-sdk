...
final class ComputerTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<ComputerToolMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([ComputerToolMessagesItem::class])]
