...
final class OpenAiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return OpenAiModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return OpenAiModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
     ...
     * @return OpenAiModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return OpenAiModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): OpenAiModelToolsItem
    {
        return new OpenAiModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
