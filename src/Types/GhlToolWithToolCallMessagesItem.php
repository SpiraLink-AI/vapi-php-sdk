...
final class GhlToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GhlToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GhlToolWithToolCallMessagesItem
    {
        return new GhlToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GhlToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GhlToolWithToolCallMessagesItem
    {
        return new GhlToolWithToolCallMessagesItem([
     ...
     * @return GhlToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GhlToolWithToolCallMessagesItem
    {
        return new GhlToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GhlToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GhlToolWithToolCallMessagesItem
    {
        return new GhlToolWithToolCallMessagesItem([
