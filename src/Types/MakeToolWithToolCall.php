...
final class MakeToolWithToolCall extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<MakeToolWithToolCallMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([MakeToolWithToolCallMessagesItem::class])]
     ...
     *   messages?: ?array<MakeToolWithToolCallMessagesItem>,
