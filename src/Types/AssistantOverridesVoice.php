 ...
 */
final class AssistantOverridesVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     */
    public static function azure(AzureVoice $azure): AssistantOverridesVoice
    {
     ...
     * @return AssistantOverridesVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return AssistantOverridesVoice
     */
    public static function customVoice(CustomVoice $customVoice): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
     ...
     * @return AssistantOverridesVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return AssistantOverridesVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return AssistantOverridesVoice
     */
    public static function hume(HumeVoice $hume): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return AssistantOverridesVoice
     */
    public static function lmnt(LmntVoice $lmnt): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return AssistantOverridesVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return AssistantOverridesVoice
     */
    public static function openai(OpenAiVoice $openai): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantOverridesVoice
     */
    public static function playht(PlayHtVoice $playht): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return AssistantOverridesVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return AssistantOverridesVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
     ...
     * @return AssistantOverridesVoice
     */
    public static function tavus(TavusVoice $tavus): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return AssistantOverridesVoice
     */
    public static function vapi(VapiVoice $vapi): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return AssistantOverridesVoice
     */
    public static function sesame(SesameVoice $sesame): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return AssistantOverridesVoice
     */
    public static function inworld(InworldVoice $inworld): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return AssistantOverridesVoice
     */
    public static function minimax(MinimaxVoice $minimax): AssistantOverridesVoice
    {
        return new AssistantOverridesVoice([
            'provider' => 'minimax',
            'value' => $minimax,
