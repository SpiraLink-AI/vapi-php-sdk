...
final class GoogleCalendarCheckAvailabilityToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoogleCalendarCheckAvailabilityToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoogleCalendarCheckAvailabilityToolMessagesItem
    {
        return new GoogleCalendarCheckAvailabilityToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoogleCalendarCheckAvailabilityToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoogleCalendarCheckAvailabilityToolMessagesItem
    {
        return new GoogleCalendarCheckAvailabilityToolMessagesItem([
     ...
     * @return GoogleCalendarCheckAvailabilityToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoogleCalendarCheckAvailabilityToolMessagesItem
    {
        return new GoogleCalendarCheckAvailabilityToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoogleCalendarCheckAvailabilityToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoogleCalendarCheckAvailabilityToolMessagesItem
    {
        return new GoogleCalendarCheckAvailabilityToolMessagesItem([
