 ...
 */
final class CreateCustomCredentialDtoAuthenticationPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'oauth2'
     ...
     * @return CreateCustomCredentialDtoAuthenticationPlan
     */
    public static function oauth2(OAuth2AuthenticationPlan $oauth2): CreateCustomCredentialDtoAuthenticationPlan
    {
        return new CreateCustomCredentialDtoAuthenticationPlan([
            'type' => 'oauth2',
            'value' => $oauth2,
        ]);
    }
     ...
     * @return CreateCustomCredentialDtoAuthenticationPlan
     */
    public static function hmac(HmacAuthenticationPlan $hmac): CreateCustomCredentialDtoAuthenticationPlan
    {
        return new CreateCustomCredentialDtoAuthenticationPlan([
            'type' => 'hmac',
            'value' => $hmac,
     ...
     * @return CreateCustomCredentialDtoAuthenticationPlan
     */
    public static function bearer(BearerAuthenticationPlan $bearer): CreateCustomCredentialDtoAuthenticationPlan
    {
        return new CreateCustomCredentialDtoAuthenticationPlan([
            'type' => 'bearer',
            'value' => $bearer,
