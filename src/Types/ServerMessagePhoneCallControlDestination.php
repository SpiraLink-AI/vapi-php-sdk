 ...
 */
final class ServerMessagePhoneCallControlDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ServerMessagePhoneCallControlDestination
     */
    public static function number(TransferDestinationNumber $number): ServerMessagePhoneCallControlDestination
    {
        return new ServerMessagePhoneCallControlDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ServerMessagePhoneCallControlDestination
     */
    public static function sip(TransferDestinationSip $sip): ServerMessagePhoneCallControlDestination
    {
        return new ServerMessagePhoneCallControlDestination([
            'type' => 'sip',
            'value' => $sip,
