...
final class CreateTelnyxPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return CreateTelnyxPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): CreateTelnyxPhoneNumberDtoHooksItem
    {
        return new CreateTelnyxPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return CreateTelnyxPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): CreateTelnyxPhoneNumberDtoHooksItem
    {
        return new CreateTelnyxPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
