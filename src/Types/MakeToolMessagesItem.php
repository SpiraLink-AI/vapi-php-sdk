...
final class MakeToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return MakeToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): MakeToolMessagesItem
    {
        return new MakeToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return MakeToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): MakeToolMessagesItem
    {
        return new MakeToolMessagesItem([
     ...
     * @return MakeToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): MakeToolMessagesItem
    {
        return new MakeToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return MakeToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): MakeToolMessagesItem
    {
        return new MakeToolMessagesItem([
