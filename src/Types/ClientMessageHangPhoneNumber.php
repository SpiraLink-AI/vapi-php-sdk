 ...
 */
final class ClientMessageHangPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageHangPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageHangPhoneNumber
    {
        return new ClientMessageHangPhoneNumber([
     ...
     * @return ClientMessageHangPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageHangPhoneNumber
    {
        return new ClientMessageHangPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageHangPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageHangPhoneNumber
    {
        return new ClientMessageHangPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageHangPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageHangPhoneNumber
    {
        return new ClientMessageHangPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageHangPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageHangPhoneNumber
    {
        return new ClientMessageHangPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
