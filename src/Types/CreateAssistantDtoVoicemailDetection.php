 ...
 */
final class CreateAssistantDtoVoicemailDetection extends JsonSerializableType
{
    /**
     * @var (
     *    'google'
     ...
     * @return CreateAssistantDtoVoicemailDetection
     */
    public static function google(GoogleVoicemailDetectionPlan $google): CreateAssistantDtoVoicemailDetection
    {
        return new CreateAssistantDtoVoicemailDetection([
            'provider' => 'google',
            'value' => $google,
        ]);
    }
     ...
     * @return CreateAssistantDtoVoicemailDetection
     */
    public static function openai(OpenAiVoicemailDetectionPlan $openai): CreateAssistantDtoVoicemailDetection
    {
        return new CreateAssistantDtoVoicemailDetection([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateAssistantDtoVoicemailDetection
     */
    public static function twilio(TwilioVoicemailDetectionPlan $twilio): CreateAssistantDtoVoicemailDetection
    {
        return new CreateAssistantDtoVoicemailDetection([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return CreateAssistantDtoVoicemailDetection
     */
    public static function vapi(VapiVoicemailDetectionPlan $vapi): CreateAssistantDtoVoicemailDetection
    {
        return new CreateAssistantDtoVoicemailDetection([
            'provider' => 'vapi',
            'value' => $vapi,
