 ...
 */
final class CreateWorkflowDtoVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function azure(AzureVoice $azure): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'azure',
            'value' => $azure,
        ]);
    }
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function customVoice(CustomVoice $customVoice): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function hume(HumeVoice $hume): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function lmnt(LmntVoice $lmnt): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function openai(OpenAiVoice $openai): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function playht(PlayHtVoice $playht): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function tavus(TavusVoice $tavus): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function vapi(VapiVoice $vapi): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function sesame(SesameVoice $sesame): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function inworld(InworldVoice $inworld): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return CreateWorkflowDtoVoice
     */
    public static function minimax(MinimaxVoice $minimax): CreateWorkflowDtoVoice
    {
        return new CreateWorkflowDtoVoice([
            'provider' => 'minimax',
            'value' => $minimax,
