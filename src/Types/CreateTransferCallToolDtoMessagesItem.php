...
final class CreateTransferCallToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateTransferCallToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateTransferCallToolDtoMessagesItem
    {
        return new CreateTransferCallToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateTransferCallToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateTransferCallToolDtoMessagesItem
    {
        return new CreateTransferCallToolDtoMessagesItem([
     ...
     * @return CreateTransferCallToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateTransferCallToolDtoMessagesItem
    {
        return new CreateTransferCallToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateTransferCallToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateTransferCallToolDtoMessagesItem
    {
        return new CreateTransferCallToolDtoMessagesItem([
