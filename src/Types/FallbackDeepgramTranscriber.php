...
final class FallbackDeepgramTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'nova-3'
    ...
    /**
     * @var ?value-of<FallbackDeepgramTranscriberLanguage> $language This is the language that will be set for the transcription. The list of languages Deepgram supports can be found here: https://developers.deepgram.com/docs/models-languages-overview
     */
     ...
     *   |string
     * )|null,
     *   language?: ?value-of<FallbackDeepgramTranscriberLanguage>,
     *   smartFormat?: ?bool,
     *   mipOptOut?: ?bool,
     *   numerals?: ?bool,
