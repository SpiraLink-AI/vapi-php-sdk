...
final class UpdateFunctionToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateFunctionToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateFunctionToolDtoMessagesItem
    {
        return new UpdateFunctionToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateFunctionToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateFunctionToolDtoMessagesItem
    {
        return new UpdateFunctionToolDtoMessagesItem([
     ...
     * @return UpdateFunctionToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateFunctionToolDtoMessagesItem
    {
        return new UpdateFunctionToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateFunctionToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateFunctionToolDtoMessagesItem
    {
        return new UpdateFunctionToolDtoMessagesItem([
