...
final class GoHighLevelCalendarEventCreateToolWithToolCall extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem::class])]
