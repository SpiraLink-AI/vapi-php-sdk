...
final class TogetherAiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return TogetherAiModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): TogetherAiModelToolsItem
    {
        return new TogetherAiModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
