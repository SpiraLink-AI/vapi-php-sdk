 ...
 */
final class ServerMessageTransferDestinationRequestPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageTransferDestinationRequestPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageTransferDestinationRequestPhoneNumber
    {
     ...
     * @return ServerMessageTransferDestinationRequestPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageTransferDestinationRequestPhoneNumber
    {
        return new ServerMessageTransferDestinationRequestPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageTransferDestinationRequestPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageTransferDestinationRequestPhoneNumber
    {
        return new ServerMessageTransferDestinationRequestPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageTransferDestinationRequestPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageTransferDestinationRequestPhoneNumber
    {
        return new ServerMessageTransferDestinationRequestPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageTransferDestinationRequestPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageTransferDestinationRequestPhoneNumber
    {
        return new ServerMessageTransferDestinationRequestPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
