...
final class UpdateByoPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return UpdateByoPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): UpdateByoPhoneNumberDtoHooksItem
    {
        return new UpdateByoPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return UpdateByoPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): UpdateByoPhoneNumberDtoHooksItem
    {
        return new UpdateByoPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
