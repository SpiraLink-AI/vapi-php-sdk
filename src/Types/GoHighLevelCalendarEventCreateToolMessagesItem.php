...
final class GoHighLevelCalendarEventCreateToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelCalendarEventCreateToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelCalendarEventCreateToolMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelCalendarEventCreateToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelCalendarEventCreateToolMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolMessagesItem([
     ...
     * @return GoHighLevelCalendarEventCreateToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelCalendarEventCreateToolMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelCalendarEventCreateToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelCalendarEventCreateToolMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolMessagesItem([
