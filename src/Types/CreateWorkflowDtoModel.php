 ...
 */
final class CreateWorkflowDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return CreateWorkflowDtoModel
     */
    public static function openai(WorkflowOpenAiModel $openai): CreateWorkflowDtoModel
    {
        return new CreateWorkflowDtoModel([
            'provider' => 'openai',
            'value' => $openai,
        ]);
    }
     ...
     * @return CreateWorkflowDtoModel
     */
    public static function anthropic(WorkflowAnthropicModel $anthropic): CreateWorkflowDtoModel
    {
        return new CreateWorkflowDtoModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
     ...
     * @return CreateWorkflowDtoModel
     */
    public static function google(WorkflowGoogleModel $google): CreateWorkflowDtoModel
    {
        return new CreateWorkflowDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateWorkflowDtoModel
     */
    public static function customLlm(WorkflowCustomModel $customLlm): CreateWorkflowDtoModel
    {
        return new CreateWorkflowDtoModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
