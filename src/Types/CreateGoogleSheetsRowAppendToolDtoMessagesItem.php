...
final class CreateGoogleSheetsRowAppendToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new CreateGoogleSheetsRowAppendToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new CreateGoogleSheetsRowAppendToolDtoMessagesItem([
     ...
     * @return CreateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new CreateGoogleSheetsRowAppendToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new CreateGoogleSheetsRowAppendToolDtoMessagesItem([
