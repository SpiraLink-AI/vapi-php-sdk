...
final class GroqModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return GroqModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return GroqModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return GroqModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return GroqModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return GroqModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return GroqModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return GroqModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return GroqModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return GroqModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return GroqModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
     ...
     * @return GroqModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return GroqModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return GroqModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): GroqModelToolsItem
    {
        return new GroqModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
