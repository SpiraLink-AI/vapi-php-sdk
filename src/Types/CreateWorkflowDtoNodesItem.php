...
final class CreateWorkflowDtoNodesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'conversation'
     ...
     * @return CreateWorkflowDtoNodesItem
     */
    public static function conversation(ConversationNode $conversation): CreateWorkflowDtoNodesItem
    {
        return new CreateWorkflowDtoNodesItem([
            'type' => 'conversation',
            'value' => $conversation,
        ]);
    }
     ...
     * @return CreateWorkflowDtoNodesItem
     */
    public static function tool(ToolNode $tool): CreateWorkflowDtoNodesItem
    {
        return new CreateWorkflowDtoNodesItem([
            'type' => 'tool',
            'value' => $tool,
