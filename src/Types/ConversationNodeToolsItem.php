...
final class ConversationNodeToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return ConversationNodeToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return ConversationNodeToolsItem
     */
    public static function bash(CreateBashToolDto $bash): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function function(CreateFunctionToolDto $function): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function query(CreateQueryToolDto $query): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
     ...
     * @return ConversationNodeToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ConversationNodeToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): ConversationNodeToolsItem
    {
        return new ConversationNodeToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
