...
final class CreateTokenDto extends JsonSerializableType
{
    /**
     * @var ?value-of<CreateTokenDtoTag> $tag This is the tag for the token. It represents its scope.
     */
    #[JsonProperty('tag')]
    public ?string $tag;
    ...
    /**
     * @param array{
     *   tag?: ?value-of<CreateTokenDtoTag>,
     *   name?: ?string,
