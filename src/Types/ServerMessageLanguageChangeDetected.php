...
final class ServerMessageLanguageChangeDetected extends JsonSerializableType
{
    /**
     * @var ?ServerMessageLanguageChangeDetectedPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
