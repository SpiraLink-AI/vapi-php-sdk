...
final class FunctionToolWithToolCall extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<FunctionToolWithToolCallMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([FunctionToolWithToolCallMessagesItem::class])]
