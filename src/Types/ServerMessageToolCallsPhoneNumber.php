 ...
 */
final class ServerMessageToolCallsPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageToolCallsPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageToolCallsPhoneNumber
    {
        return new ServerMessageToolCallsPhoneNumber([
     ...
     * @return ServerMessageToolCallsPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageToolCallsPhoneNumber
    {
        return new ServerMessageToolCallsPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageToolCallsPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageToolCallsPhoneNumber
    {
        return new ServerMessageToolCallsPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageToolCallsPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageToolCallsPhoneNumber
    {
        return new ServerMessageToolCallsPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageToolCallsPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageToolCallsPhoneNumber
    {
        return new ServerMessageToolCallsPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
