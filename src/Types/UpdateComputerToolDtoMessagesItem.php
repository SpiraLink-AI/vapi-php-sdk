...
final class UpdateComputerToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateComputerToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateComputerToolDtoMessagesItem
    {
        return new UpdateComputerToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateComputerToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateComputerToolDtoMessagesItem
    {
        return new UpdateComputerToolDtoMessagesItem([
     ...
     * @return UpdateComputerToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateComputerToolDtoMessagesItem
    {
        return new UpdateComputerToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateComputerToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateComputerToolDtoMessagesItem
    {
        return new UpdateComputerToolDtoMessagesItem([
