 ...
 */
final class UpdateWorkflowDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function google(GoogleTranscriber $google): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateWorkflowDtoTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): UpdateWorkflowDtoTranscriber
    {
        return new UpdateWorkflowDtoTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
