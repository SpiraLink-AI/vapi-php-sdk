 ...
 */
final class CreateAssistantDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     * @return CreateAssistantDtoModel
     */
    public static function anthropic(AnthropicModel $anthropic): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
        ]);
    }
     ...
     * @return CreateAssistantDtoModel
     */
    public static function anyscale(AnyscaleModel $anyscale): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function cerebras(CerebrasModel $cerebras): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function customLlm(CustomLlmModel $customLlm): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function deepinfra(DeepInfraModel $deepinfra): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'deepinfra',
            'value' => $deepinfra,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function deepSeek(DeepSeekModel $deepSeek): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function google(GoogleModel $google): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function groq(GroqModel $groq): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function inflectionAi(InflectionAiModel $inflectionAi): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
     ...
     * @return CreateAssistantDtoModel
     */
    public static function openai(OpenAiModel $openai): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function openrouter(OpenRouterModel $openrouter): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return CreateAssistantDtoModel
     */
    public static function perplexityAi(PerplexityAiModel $perplexityAi): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
     ...
     * @return CreateAssistantDtoModel
     */
    public static function togetherAi(TogetherAiModel $togetherAi): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
     ...
     * @return CreateAssistantDtoModel
     */
    public static function xai(XaiModel $xai): CreateAssistantDtoModel
    {
        return new CreateAssistantDtoModel([
            'provider' => 'xai',
            'value' => $xai,
