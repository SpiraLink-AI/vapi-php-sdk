...
final class TransferCallTool extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<TransferCallToolDestinationsItem> $destinations These are the destinations that the call can be transferred to. If no destinations are provided, server.url will be used to get the transfer destination once the tool is called.
     */
    #[JsonProperty('destinations'), ArrayType([TransferCallToolDestinationsItem::class])]
