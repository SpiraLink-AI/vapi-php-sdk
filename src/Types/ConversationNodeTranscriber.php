 ...
 */
final class ConversationNodeTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return ConversationNodeTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
     ...
     * @return ConversationNodeTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
     ...
     * @return ConversationNodeTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function google(GoogleTranscriber $google): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
     ...
     * @return ConversationNodeTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
     ...
     * @return ConversationNodeTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return ConversationNodeTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): ConversationNodeTranscriber
    {
        return new ConversationNodeTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
