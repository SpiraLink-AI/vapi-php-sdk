...
final class GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem([
     ...
     * @return GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem([
