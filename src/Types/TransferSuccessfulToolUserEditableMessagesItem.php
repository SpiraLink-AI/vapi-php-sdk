...
final class TransferSuccessfulToolUserEditableMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return TransferSuccessfulToolUserEditableMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): TransferSuccessfulToolUserEditableMessagesItem
    {
        return new TransferSuccessfulToolUserEditableMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return TransferSuccessfulToolUserEditableMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): TransferSuccessfulToolUserEditableMessagesItem
    {
        return new TransferSuccessfulToolUserEditableMessagesItem([
     ...
     * @return TransferSuccessfulToolUserEditableMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): TransferSuccessfulToolUserEditableMessagesItem
    {
        return new TransferSuccessfulToolUserEditableMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return TransferSuccessfulToolUserEditableMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): TransferSuccessfulToolUserEditableMessagesItem
    {
        return new TransferSuccessfulToolUserEditableMessagesItem([
