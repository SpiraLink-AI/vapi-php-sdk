 ...
 */
final class ServerMessageAssistantRequestPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageAssistantRequestPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageAssistantRequestPhoneNumber
    {
     ...
     * @return ServerMessageAssistantRequestPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageAssistantRequestPhoneNumber
    {
        return new ServerMessageAssistantRequestPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageAssistantRequestPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageAssistantRequestPhoneNumber
    {
        return new ServerMessageAssistantRequestPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageAssistantRequestPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageAssistantRequestPhoneNumber
    {
        return new ServerMessageAssistantRequestPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageAssistantRequestPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageAssistantRequestPhoneNumber
    {
        return new ServerMessageAssistantRequestPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
