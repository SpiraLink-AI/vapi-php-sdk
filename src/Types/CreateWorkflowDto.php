...
final class CreateWorkflowDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?CreateWorkflowDtoModel $model
     */
    #[JsonProperty('model')]
    public ?CreateWorkflowDtoModel $model;
     ...
     *
     * @var ?CreateWorkflowDtoTranscriber $transcriber
     */
    #[JsonProperty('transcriber')]
    public ?CreateWorkflowDtoTranscriber $transcriber;
     ...
     *
     * @var ?CreateWorkflowDtoVoice $voice
     */
    #[JsonProperty('voice')]
    public ?CreateWorkflowDtoVoice $voice;
     ...
     *
     * @var (
     *    value-of<CreateWorkflowDtoBackgroundSoundZero>
     *   |string
    ...
    /**
     * @var ?array<CreateWorkflowDtoCredentialsItem> $credentials These are dynamic credentials that will be used for the workflow calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
     */
    #[JsonProperty('credentials'), ArrayType([CreateWorkflowDtoCredentialsItem::class])]
    public ?array $credentials;

    /**
     * @var ?CreateWorkflowDtoVoicemailDetection $voicemailDetection This is the voicemail detection plan for the workflow.
     */
    #[JsonProperty('voicemailDetection')]
    public ?CreateWorkflowDtoVoicemailDetection $voicemailDetection;
    ...
    /**
     * @param array{
     *   nodes: array<CreateWorkflowDtoNodesItem>,
     *   name: string,
     *   edges: array<Edge>,
     *   model?: ?CreateWorkflowDtoModel,
     *   transcriber?: ?CreateWorkflowDtoTranscriber,
     *   voice?: ?CreateWorkflowDtoVoice,
     ...
     *   |CallHookCustomerSpeechTimeout
     * )>,
     *   credentials?: ?array<CreateWorkflowDtoCredentialsItem>,
     *   voicemailDetection?: ?CreateWorkflowDtoVoicemailDetection,
