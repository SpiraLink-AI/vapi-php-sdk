...
final class TemplateDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): TemplateDetails
    {
     ...
     * @return TemplateDetails
     */
    public static function bash(CreateBashToolDto $bash): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return TemplateDetails
     */
    public static function computer(CreateComputerToolDto $computer): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return TemplateDetails
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return TemplateDetails
     */
    public static function endCall(CreateEndCallToolDto $endCall): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return TemplateDetails
     */
    public static function function(CreateFunctionToolDto $function): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'function',
            'value' => $function,
     ...
     * @return TemplateDetails
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function handoff(CreateHandoffToolDto $handoff): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return TemplateDetails
     */
    public static function mcp(CreateMcpToolDto $mcp): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return TemplateDetails
     */
    public static function query(CreateQueryToolDto $query): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'query',
            'value' => $query,
     ...
     * @return TemplateDetails
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): TemplateDetails
    {
        return new TemplateDetails([
     ...
     * @return TemplateDetails
     */
    public static function sms(CreateSmsToolDto $sms): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return TemplateDetails
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return TemplateDetails
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): TemplateDetails
    {
        return new TemplateDetails([
            'type' => 'transferCall',
            'value' => $transferCall,
