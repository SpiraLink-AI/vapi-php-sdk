...
final class CallHookCustomerSpeechTimeoutDoItem extends JsonSerializableType
{
    /**
     * @var (
     *    'say'
     ...
     */
    public static function say(SayHookAction $say): CallHookCustomerSpeechTimeoutDoItem
    {
     ...
     * @return CallHookCustomerSpeechTimeoutDoItem
     */
    public static function tool(ToolCallHookAction $tool): CallHookCustomerSpeechTimeoutDoItem
    {
        return new CallHookCustomerSpeechTimeoutDoItem([
            'type' => 'tool',
            'value' => $tool,
