...
final class MakeToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return MakeToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): MakeToolWithToolCallMessagesItem
    {
        return new MakeToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return MakeToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): MakeToolWithToolCallMessagesItem
    {
        return new MakeToolWithToolCallMessagesItem([
     ...
     * @return MakeToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): MakeToolWithToolCallMessagesItem
    {
        return new MakeToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return MakeToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): MakeToolWithToolCallMessagesItem
    {
        return new MakeToolWithToolCallMessagesItem([
