 ...
 */
final class ClientMessageConversationUpdatePhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageConversationUpdatePhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageConversationUpdatePhoneNumber
    {
        return new ClientMessageConversationUpdatePhoneNumber([
     ...
     * @return ClientMessageConversationUpdatePhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageConversationUpdatePhoneNumber
    {
        return new ClientMessageConversationUpdatePhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageConversationUpdatePhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageConversationUpdatePhoneNumber
    {
        return new ClientMessageConversationUpdatePhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageConversationUpdatePhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageConversationUpdatePhoneNumber
    {
        return new ClientMessageConversationUpdatePhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageConversationUpdatePhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageConversationUpdatePhoneNumber
    {
        return new ClientMessageConversationUpdatePhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
