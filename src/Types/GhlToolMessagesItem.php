...
final class GhlToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GhlToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GhlToolMessagesItem
    {
        return new GhlToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GhlToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GhlToolMessagesItem
    {
        return new GhlToolMessagesItem([
     ...
     * @return GhlToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GhlToolMessagesItem
    {
        return new GhlToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GhlToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GhlToolMessagesItem
    {
        return new GhlToolMessagesItem([
