 ...
 */
final class ClientMessageSessionUpdatedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageSessionUpdatedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageSessionUpdatedPhoneNumber
    {
        return new ClientMessageSessionUpdatedPhoneNumber([
     ...
     * @return ClientMessageSessionUpdatedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageSessionUpdatedPhoneNumber
    {
        return new ClientMessageSessionUpdatedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageSessionUpdatedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageSessionUpdatedPhoneNumber
    {
        return new ClientMessageSessionUpdatedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageSessionUpdatedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageSessionUpdatedPhoneNumber
    {
        return new ClientMessageSessionUpdatedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageSessionUpdatedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageSessionUpdatedPhoneNumber
    {
        return new ClientMessageSessionUpdatedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
