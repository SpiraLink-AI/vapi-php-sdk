...
final class UpdateTelnyxPhoneNumberDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?UpdateTelnyxPhoneNumberDtoFallbackDestination $fallbackDestination
     */
    #[JsonProperty('fallbackDestination')]
    public ?UpdateTelnyxPhoneNumberDtoFallbackDestination $fallbackDestination;

    /**
     * @var ?array<UpdateTelnyxPhoneNumberDtoHooksItem> $hooks This is the hooks that will be used for incoming calls to this phone number.
     */
    #[JsonProperty('hooks'), ArrayType([UpdateTelnyxPhoneNumberDtoHooksItem::class])]
    public ?array $hooks;
    ...
    /**
     * @param array{
     *   fallbackDestination?: ?UpdateTelnyxPhoneNumberDtoFallbackDestination,
     *   hooks?: ?array<UpdateTelnyxPhoneNumberDtoHooksItem>,
     *   name?: ?string,
     *   assistantId?: ?string,
     *   workflowId?: ?string,
     *   squadId?: ?string,
