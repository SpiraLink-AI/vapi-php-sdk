...
final class CreateQueryToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateQueryToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateQueryToolDtoMessagesItem
    {
        return new CreateQueryToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateQueryToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateQueryToolDtoMessagesItem
    {
        return new CreateQueryToolDtoMessagesItem([
     ...
     * @return CreateQueryToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateQueryToolDtoMessagesItem
    {
        return new CreateQueryToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateQueryToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateQueryToolDtoMessagesItem
    {
        return new CreateQueryToolDtoMessagesItem([
