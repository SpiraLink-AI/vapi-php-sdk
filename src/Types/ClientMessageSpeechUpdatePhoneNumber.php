 ...
 */
final class ClientMessageSpeechUpdatePhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageSpeechUpdatePhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageSpeechUpdatePhoneNumber
    {
        return new ClientMessageSpeechUpdatePhoneNumber([
     ...
     * @return ClientMessageSpeechUpdatePhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageSpeechUpdatePhoneNumber
    {
        return new ClientMessageSpeechUpdatePhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageSpeechUpdatePhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageSpeechUpdatePhoneNumber
    {
        return new ClientMessageSpeechUpdatePhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageSpeechUpdatePhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageSpeechUpdatePhoneNumber
    {
        return new ClientMessageSpeechUpdatePhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageSpeechUpdatePhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageSpeechUpdatePhoneNumber
    {
        return new ClientMessageSpeechUpdatePhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
