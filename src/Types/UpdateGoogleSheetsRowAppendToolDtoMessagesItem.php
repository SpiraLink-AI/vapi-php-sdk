...
final class UpdateGoogleSheetsRowAppendToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new UpdateGoogleSheetsRowAppendToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new UpdateGoogleSheetsRowAppendToolDtoMessagesItem([
     ...
     * @return UpdateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new UpdateGoogleSheetsRowAppendToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoogleSheetsRowAppendToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoogleSheetsRowAppendToolDtoMessagesItem
    {
        return new UpdateGoogleSheetsRowAppendToolDtoMessagesItem([
