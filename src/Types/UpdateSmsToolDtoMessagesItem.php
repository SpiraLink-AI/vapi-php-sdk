...
final class UpdateSmsToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateSmsToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateSmsToolDtoMessagesItem
    {
        return new UpdateSmsToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateSmsToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateSmsToolDtoMessagesItem
    {
        return new UpdateSmsToolDtoMessagesItem([
     ...
     * @return UpdateSmsToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateSmsToolDtoMessagesItem
    {
        return new UpdateSmsToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateSmsToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateSmsToolDtoMessagesItem
    {
        return new UpdateSmsToolDtoMessagesItem([
