...
final class UpdateGoHighLevelContactGetToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactGetToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactGetToolDtoMessagesItem([
     ...
     * @return UpdateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactGetToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactGetToolDtoMessagesItem([
