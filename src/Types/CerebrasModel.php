...
final class CerebrasModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CerebrasModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([CerebrasModelToolsItem::class])]
    public ?array $tools;
    ...
    /**
     * @var value-of<CerebrasModelModel> $model This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<CerebrasModelModel>,
     *   messages?: ?array<OpenAiMessage>,
     *   tools?: ?array<CerebrasModelToolsItem>,
