...
final class UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
     ...
     * @return UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
