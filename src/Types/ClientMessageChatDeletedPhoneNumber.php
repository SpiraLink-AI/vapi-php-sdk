 ...
 */
final class ClientMessageChatDeletedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageChatDeletedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageChatDeletedPhoneNumber
    {
        return new ClientMessageChatDeletedPhoneNumber([
     ...
     * @return ClientMessageChatDeletedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageChatDeletedPhoneNumber
    {
        return new ClientMessageChatDeletedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageChatDeletedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageChatDeletedPhoneNumber
    {
        return new ClientMessageChatDeletedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageChatDeletedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageChatDeletedPhoneNumber
    {
        return new ClientMessageChatDeletedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageChatDeletedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageChatDeletedPhoneNumber
    {
        return new ClientMessageChatDeletedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
