 ...
 */
final class ServerMessageKnowledgeBaseRequestPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageKnowledgeBaseRequestPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageKnowledgeBaseRequestPhoneNumber
    {
     ...
     * @return ServerMessageKnowledgeBaseRequestPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageKnowledgeBaseRequestPhoneNumber
    {
        return new ServerMessageKnowledgeBaseRequestPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageKnowledgeBaseRequestPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageKnowledgeBaseRequestPhoneNumber
    {
        return new ServerMessageKnowledgeBaseRequestPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageKnowledgeBaseRequestPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageKnowledgeBaseRequestPhoneNumber
    {
        return new ServerMessageKnowledgeBaseRequestPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageKnowledgeBaseRequestPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageKnowledgeBaseRequestPhoneNumber
    {
        return new ServerMessageKnowledgeBaseRequestPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
