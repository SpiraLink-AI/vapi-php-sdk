...
final class UpdateToolTemplateDtoDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function bash(CreateBashToolDto $bash): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function computer(CreateComputerToolDto $computer): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function endCall(CreateEndCallToolDto $endCall): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function function(CreateFunctionToolDto $function): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'function',
            'value' => $function,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function handoff(CreateHandoffToolDto $handoff): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function mcp(CreateMcpToolDto $mcp): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function query(CreateQueryToolDto $query): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'query',
            'value' => $query,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function sms(CreateSmsToolDto $sms): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return UpdateToolTemplateDtoDetails
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): UpdateToolTemplateDtoDetails
    {
        return new UpdateToolTemplateDtoDetails([
            'type' => 'transferCall',
            'value' => $transferCall,
