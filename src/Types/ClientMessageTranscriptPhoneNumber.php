 ...
 */
final class ClientMessageTranscriptPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageTranscriptPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageTranscriptPhoneNumber
    {
        return new ClientMessageTranscriptPhoneNumber([
     ...
     * @return ClientMessageTranscriptPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageTranscriptPhoneNumber
    {
        return new ClientMessageTranscriptPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageTranscriptPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageTranscriptPhoneNumber
    {
        return new ClientMessageTranscriptPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageTranscriptPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageTranscriptPhoneNumber
    {
        return new ClientMessageTranscriptPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageTranscriptPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageTranscriptPhoneNumber
    {
        return new ClientMessageTranscriptPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
