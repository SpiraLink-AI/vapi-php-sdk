...
final class ApiRequestToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return ApiRequestToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): ApiRequestToolMessagesItem
    {
        return new ApiRequestToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return ApiRequestToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): ApiRequestToolMessagesItem
    {
        return new ApiRequestToolMessagesItem([
     ...
     * @return ApiRequestToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): ApiRequestToolMessagesItem
    {
        return new ApiRequestToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return ApiRequestToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): ApiRequestToolMessagesItem
    {
        return new ApiRequestToolMessagesItem([
