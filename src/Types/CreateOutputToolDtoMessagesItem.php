...
final class CreateOutputToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateOutputToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateOutputToolDtoMessagesItem
    {
        return new CreateOutputToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateOutputToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateOutputToolDtoMessagesItem
    {
        return new CreateOutputToolDtoMessagesItem([
     ...
     * @return CreateOutputToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateOutputToolDtoMessagesItem
    {
        return new CreateOutputToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateOutputToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateOutputToolDtoMessagesItem
    {
        return new CreateOutputToolDtoMessagesItem([
