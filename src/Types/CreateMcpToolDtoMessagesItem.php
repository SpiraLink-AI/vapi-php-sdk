...
final class CreateMcpToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateMcpToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateMcpToolDtoMessagesItem
    {
        return new CreateMcpToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateMcpToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateMcpToolDtoMessagesItem
    {
        return new CreateMcpToolDtoMessagesItem([
     ...
     * @return CreateMcpToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateMcpToolDtoMessagesItem
    {
        return new CreateMcpToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateMcpToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateMcpToolDtoMessagesItem
    {
        return new CreateMcpToolDtoMessagesItem([
