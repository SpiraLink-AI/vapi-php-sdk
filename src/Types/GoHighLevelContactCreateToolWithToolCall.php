...
final class GoHighLevelContactCreateToolWithToolCall extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<GoHighLevelContactCreateToolWithToolCallMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([GoHighLevelContactCreateToolWithToolCallMessagesItem::class])]
