 ...
 */
final class ServerMessageSpeechUpdatePhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageSpeechUpdatePhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageSpeechUpdatePhoneNumber
    {
        return new ServerMessageSpeechUpdatePhoneNumber([
     ...
     * @return ServerMessageSpeechUpdatePhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageSpeechUpdatePhoneNumber
    {
        return new ServerMessageSpeechUpdatePhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageSpeechUpdatePhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageSpeechUpdatePhoneNumber
    {
        return new ServerMessageSpeechUpdatePhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageSpeechUpdatePhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageSpeechUpdatePhoneNumber
    {
        return new ServerMessageSpeechUpdatePhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageSpeechUpdatePhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageSpeechUpdatePhoneNumber
    {
        return new ServerMessageSpeechUpdatePhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
