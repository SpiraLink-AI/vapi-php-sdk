...
final class GoHighLevelContactGetToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelContactGetToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelContactGetToolMessagesItem
    {
        return new GoHighLevelContactGetToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelContactGetToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelContactGetToolMessagesItem
    {
        return new GoHighLevelContactGetToolMessagesItem([
     ...
     * @return GoHighLevelContactGetToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelContactGetToolMessagesItem
    {
        return new GoHighLevelContactGetToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelContactGetToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelContactGetToolMessagesItem
    {
        return new GoHighLevelContactGetToolMessagesItem([
