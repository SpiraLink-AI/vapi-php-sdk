...
final class TextEditorTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<TextEditorToolMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([TextEditorToolMessagesItem::class])]
