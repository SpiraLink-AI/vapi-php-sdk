 ...
 */
final class UpdateWorkflowDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return UpdateWorkflowDtoModel
     */
    public static function openai(WorkflowOpenAiModel $openai): UpdateWorkflowDtoModel
    {
        return new UpdateWorkflowDtoModel([
            'provider' => 'openai',
            'value' => $openai,
        ]);
    }
     ...
     * @return UpdateWorkflowDtoModel
     */
    public static function anthropic(WorkflowAnthropicModel $anthropic): UpdateWorkflowDtoModel
    {
        return new UpdateWorkflowDtoModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
     ...
     * @return UpdateWorkflowDtoModel
     */
    public static function google(WorkflowGoogleModel $google): UpdateWorkflowDtoModel
    {
        return new UpdateWorkflowDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return UpdateWorkflowDtoModel
     */
    public static function customLlm(WorkflowCustomModel $customLlm): UpdateWorkflowDtoModel
    {
        return new UpdateWorkflowDtoModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
