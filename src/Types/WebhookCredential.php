...
final class WebhookCredential extends JsonSerializableType
{
    /**
    ...
    /**
     * @var WebhookCredentialAuthenticationPlan $authenticationPlan This is the authentication plan. Supports OAuth2 RFC 6749, HMAC signing, and Bearer authentication.
     */
    #[JsonProperty('authenticationPlan')]
    public WebhookCredentialAuthenticationPlan $authenticationPlan;
