 ...
 */
final class ClientInboundMessageTransferDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ClientInboundMessageTransferDestination
     */
    public static function number(TransferDestinationNumber $number): ClientInboundMessageTransferDestination
    {
        return new ClientInboundMessageTransferDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ClientInboundMessageTransferDestination
     */
    public static function sip(TransferDestinationSip $sip): ClientInboundMessageTransferDestination
    {
        return new ClientInboundMessageTransferDestination([
            'type' => 'sip',
            'value' => $sip,
