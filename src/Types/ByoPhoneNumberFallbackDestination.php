 ...
 */
final class ByoPhoneNumberFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ByoPhoneNumberFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): ByoPhoneNumberFallbackDestination
    {
        return new ByoPhoneNumberFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ByoPhoneNumberFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): ByoPhoneNumberFallbackDestination
    {
        return new ByoPhoneNumberFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
