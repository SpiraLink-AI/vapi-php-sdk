 ...
 */
final class WorkflowUserEditableTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function google(GoogleTranscriber $google): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return WorkflowUserEditableTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): WorkflowUserEditableTranscriber
    {
        return new WorkflowUserEditableTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
