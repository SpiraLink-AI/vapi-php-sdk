 ...
 */
final class RecordingConsentPlanVerbalVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     */
    public static function azure(AzureVoice $azure): RecordingConsentPlanVerbalVoice
    {
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function customVoice(CustomVoice $customVoice): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function hume(HumeVoice $hume): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function lmnt(LmntVoice $lmnt): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function openai(OpenAiVoice $openai): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function playht(PlayHtVoice $playht): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function tavus(TavusVoice $tavus): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function vapi(VapiVoice $vapi): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function sesame(SesameVoice $sesame): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function inworld(InworldVoice $inworld): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return RecordingConsentPlanVerbalVoice
     */
    public static function minimax(MinimaxVoice $minimax): RecordingConsentPlanVerbalVoice
    {
        return new RecordingConsentPlanVerbalVoice([
            'provider' => 'minimax',
            'value' => $minimax,
