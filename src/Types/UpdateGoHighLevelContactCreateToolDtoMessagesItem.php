...
final class UpdateGoHighLevelContactCreateToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactCreateToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactCreateToolDtoMessagesItem([
     ...
     * @return UpdateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactCreateToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new UpdateGoHighLevelContactCreateToolDtoMessagesItem([
