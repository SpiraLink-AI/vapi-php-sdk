...
final class TransferPlan extends JsonSerializableType
{
    /**
     ...
     *
     * @var value-of<TransferPlanMode> $mode
     */
    #[JsonProperty('mode')]
    public string $mode;
     ...
     *
     * @var ?array<string, mixed> $sipVerb
     */
    #[JsonProperty('sipVerb'), ArrayType(['string' => 'mixed'])]
     ...
     * - Supported formats: MP3 and WAV.
     *
     * @var ?string $transferCompleteAudioUrl
     */
     ...
     * @default false
     *
     * @var ?bool $sipHeadersInReferToEnabled
     */
    #[JsonProperty('sipHeadersInReferToEnabled')]
    public ?bool $sipHeadersInReferToEnabled;
    ...
    public ?TransferFallbackPlan $fallbackPlan;

    /**
     * @param array{
     *   mode: value-of<TransferPlanMode>,
     *   message?: (
     *    string
     *   |CustomMessage
     * )|null,
