...
final class UpdateMcpToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateMcpToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateMcpToolDtoMessagesItem
    {
        return new UpdateMcpToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateMcpToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateMcpToolDtoMessagesItem
    {
        return new UpdateMcpToolDtoMessagesItem([
     ...
     * @return UpdateMcpToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateMcpToolDtoMessagesItem
    {
        return new UpdateMcpToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateMcpToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateMcpToolDtoMessagesItem
    {
        return new UpdateMcpToolDtoMessagesItem([
