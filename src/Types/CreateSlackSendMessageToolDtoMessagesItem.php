...
final class CreateSlackSendMessageToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateSlackSendMessageToolDtoMessagesItem
    {
        return new CreateSlackSendMessageToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateSlackSendMessageToolDtoMessagesItem
    {
        return new CreateSlackSendMessageToolDtoMessagesItem([
     ...
     * @return CreateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateSlackSendMessageToolDtoMessagesItem
    {
        return new CreateSlackSendMessageToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateSlackSendMessageToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateSlackSendMessageToolDtoMessagesItem
    {
        return new CreateSlackSendMessageToolDtoMessagesItem([
