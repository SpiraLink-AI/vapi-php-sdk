...
final class EvalGoogleModel extends JsonSerializableType
{
    /**
     * @var value-of<EvalGoogleModelModel> $model This is the name of the model. Ex. gpt-4o
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<EvalGoogleModelModel>,
     *   temperature?: ?float,
     *   maxTokens?: ?float,
     * } $values
     */
