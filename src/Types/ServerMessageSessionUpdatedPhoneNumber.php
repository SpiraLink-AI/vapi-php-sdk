 ...
 */
final class ServerMessageSessionUpdatedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageSessionUpdatedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageSessionUpdatedPhoneNumber
    {
        return new ServerMessageSessionUpdatedPhoneNumber([
     ...
     * @return ServerMessageSessionUpdatedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageSessionUpdatedPhoneNumber
    {
        return new ServerMessageSessionUpdatedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageSessionUpdatedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageSessionUpdatedPhoneNumber
    {
        return new ServerMessageSessionUpdatedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageSessionUpdatedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageSessionUpdatedPhoneNumber
    {
        return new ServerMessageSessionUpdatedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageSessionUpdatedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageSessionUpdatedPhoneNumber
    {
        return new ServerMessageSessionUpdatedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
