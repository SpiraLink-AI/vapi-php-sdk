...
final class CreateApiRequestToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateApiRequestToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateApiRequestToolDtoMessagesItem
    {
        return new CreateApiRequestToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateApiRequestToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateApiRequestToolDtoMessagesItem
    {
        return new CreateApiRequestToolDtoMessagesItem([
     ...
     * @return CreateApiRequestToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateApiRequestToolDtoMessagesItem
    {
        return new CreateApiRequestToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateApiRequestToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateApiRequestToolDtoMessagesItem
    {
        return new CreateApiRequestToolDtoMessagesItem([
