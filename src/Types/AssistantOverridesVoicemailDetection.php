 ...
 */
final class AssistantOverridesVoicemailDetection extends JsonSerializableType
{
    /**
     * @var (
     *    'google'
     ...
     * @return AssistantOverridesVoicemailDetection
     */
    public static function google(GoogleVoicemailDetectionPlan $google): AssistantOverridesVoicemailDetection
    {
        return new AssistantOverridesVoicemailDetection([
            'provider' => 'google',
            'value' => $google,
        ]);
    }
     ...
     * @return AssistantOverridesVoicemailDetection
     */
    public static function openai(OpenAiVoicemailDetectionPlan $openai): AssistantOverridesVoicemailDetection
    {
        return new AssistantOverridesVoicemailDetection([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantOverridesVoicemailDetection
     */
    public static function twilio(TwilioVoicemailDetectionPlan $twilio): AssistantOverridesVoicemailDetection
    {
        return new AssistantOverridesVoicemailDetection([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return AssistantOverridesVoicemailDetection
     */
    public static function vapi(VapiVoicemailDetectionPlan $vapi): AssistantOverridesVoicemailDetection
    {
        return new AssistantOverridesVoicemailDetection([
            'provider' => 'vapi',
            'value' => $vapi,
