...
final class GoHighLevelCalendarAvailabilityToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelCalendarAvailabilityToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelCalendarAvailabilityToolMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelCalendarAvailabilityToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelCalendarAvailabilityToolMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolMessagesItem([
     ...
     * @return GoHighLevelCalendarAvailabilityToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelCalendarAvailabilityToolMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelCalendarAvailabilityToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelCalendarAvailabilityToolMessagesItem
    {
        return new GoHighLevelCalendarAvailabilityToolMessagesItem([
