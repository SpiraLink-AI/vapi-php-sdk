 ...
 */
final class ConversationNodeVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return ConversationNodeVoice
     */
    public static function azure(AzureVoice $azure): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'azure',
            'value' => $azure,
        ]);
    }
     ...
     * @return ConversationNodeVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return ConversationNodeVoice
     */
    public static function customVoice(CustomVoice $customVoice): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
     ...
     * @return ConversationNodeVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return ConversationNodeVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return ConversationNodeVoice
     */
    public static function hume(HumeVoice $hume): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return ConversationNodeVoice
     */
    public static function lmnt(LmntVoice $lmnt): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return ConversationNodeVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return ConversationNodeVoice
     */
    public static function openai(OpenAiVoice $openai): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return ConversationNodeVoice
     */
    public static function playht(PlayHtVoice $playht): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return ConversationNodeVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return ConversationNodeVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
     ...
     * @return ConversationNodeVoice
     */
    public static function tavus(TavusVoice $tavus): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return ConversationNodeVoice
     */
    public static function vapi(VapiVoice $vapi): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ConversationNodeVoice
     */
    public static function sesame(SesameVoice $sesame): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return ConversationNodeVoice
     */
    public static function inworld(InworldVoice $inworld): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return ConversationNodeVoice
     */
    public static function minimax(MinimaxVoice $minimax): ConversationNodeVoice
    {
        return new ConversationNodeVoice([
            'provider' => 'minimax',
            'value' => $minimax,
