...
final class UpdateGhlToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGhlToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGhlToolDtoMessagesItem
    {
        return new UpdateGhlToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGhlToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGhlToolDtoMessagesItem
    {
        return new UpdateGhlToolDtoMessagesItem([
     ...
     * @return UpdateGhlToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGhlToolDtoMessagesItem
    {
        return new UpdateGhlToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGhlToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGhlToolDtoMessagesItem
    {
        return new UpdateGhlToolDtoMessagesItem([
