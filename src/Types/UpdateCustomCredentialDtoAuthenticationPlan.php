 ...
 */
final class UpdateCustomCredentialDtoAuthenticationPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'oauth2'
     ...
     * @return UpdateCustomCredentialDtoAuthenticationPlan
     */
    public static function oauth2(OAuth2AuthenticationPlan $oauth2): UpdateCustomCredentialDtoAuthenticationPlan
    {
        return new UpdateCustomCredentialDtoAuthenticationPlan([
            'type' => 'oauth2',
            'value' => $oauth2,
        ]);
    }
     ...
     * @return UpdateCustomCredentialDtoAuthenticationPlan
     */
    public static function hmac(HmacAuthenticationPlan $hmac): UpdateCustomCredentialDtoAuthenticationPlan
    {
        return new UpdateCustomCredentialDtoAuthenticationPlan([
            'type' => 'hmac',
            'value' => $hmac,
     ...
     * @return UpdateCustomCredentialDtoAuthenticationPlan
     */
    public static function bearer(BearerAuthenticationPlan $bearer): UpdateCustomCredentialDtoAuthenticationPlan
    {
        return new UpdateCustomCredentialDtoAuthenticationPlan([
            'type' => 'bearer',
            'value' => $bearer,
