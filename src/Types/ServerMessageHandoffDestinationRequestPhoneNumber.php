 ...
 */
final class ServerMessageHandoffDestinationRequestPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageHandoffDestinationRequestPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageHandoffDestinationRequestPhoneNumber
    {
        return new ServerMessageHandoffDestinationRequestPhoneNumber([
     ...
     * @return ServerMessageHandoffDestinationRequestPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageHandoffDestinationRequestPhoneNumber
    {
        return new ServerMessageHandoffDestinationRequestPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageHandoffDestinationRequestPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageHandoffDestinationRequestPhoneNumber
    {
        return new ServerMessageHandoffDestinationRequestPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageHandoffDestinationRequestPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageHandoffDestinationRequestPhoneNumber
    {
        return new ServerMessageHandoffDestinationRequestPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageHandoffDestinationRequestPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageHandoffDestinationRequestPhoneNumber
    {
        return new ServerMessageHandoffDestinationRequestPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
