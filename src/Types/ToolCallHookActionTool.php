 ...
 */
final class ToolCallHookActionTool extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): ToolCallHookActionTool
    {
     ...
     * @return ToolCallHookActionTool
     */
    public static function bash(CreateBashToolDto $bash): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ToolCallHookActionTool
     */
    public static function computer(CreateComputerToolDto $computer): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ToolCallHookActionTool
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ToolCallHookActionTool
     */
    public static function endCall(CreateEndCallToolDto $endCall): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ToolCallHookActionTool
     */
    public static function function(CreateFunctionToolDto $function): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ToolCallHookActionTool
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function handoff(CreateHandoffToolDto $handoff): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ToolCallHookActionTool
     */
    public static function mcp(CreateMcpToolDto $mcp): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ToolCallHookActionTool
     */
    public static function query(CreateQueryToolDto $query): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ToolCallHookActionTool
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
     ...
     * @return ToolCallHookActionTool
     */
    public static function sms(CreateSmsToolDto $sms): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ToolCallHookActionTool
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ToolCallHookActionTool
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): ToolCallHookActionTool
    {
        return new ToolCallHookActionTool([
            'type' => 'transferCall',
            'value' => $transferCall,
