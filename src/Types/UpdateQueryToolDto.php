...
final class UpdateQueryToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<UpdateQueryToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([UpdateQueryToolDtoMessagesItem::class])]
    public ?array $messages;

    /**
     * @var ?array<KnowledgeBase> $knowledgeBases The knowledge bases to query
     */
    ...
    /**
     * @param array{
     *   messages?: ?array<UpdateQueryToolDtoMessagesItem>,
