...
final class UpdateTransferCallToolDtoDestinationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return UpdateTransferCallToolDtoDestinationsItem
     */
    public static function assistant(TransferDestinationAssistant $assistant): UpdateTransferCallToolDtoDestinationsItem
    {
        return new UpdateTransferCallToolDtoDestinationsItem([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return UpdateTransferCallToolDtoDestinationsItem
     */
    public static function number(TransferDestinationNumber $number): UpdateTransferCallToolDtoDestinationsItem
    {
        return new UpdateTransferCallToolDtoDestinationsItem([
            'type' => 'number',
            'value' => $number,
     ...
     * @return UpdateTransferCallToolDtoDestinationsItem
     */
    public static function sip(TransferDestinationSip $sip): UpdateTransferCallToolDtoDestinationsItem
    {
        return new UpdateTransferCallToolDtoDestinationsItem([
            'type' => 'sip',
            'value' => $sip,
