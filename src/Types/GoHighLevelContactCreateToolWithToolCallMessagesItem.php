...
final class GoHighLevelContactCreateToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelContactCreateToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelContactCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactCreateToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelContactCreateToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelContactCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactCreateToolWithToolCallMessagesItem([
     ...
     * @return GoHighLevelContactCreateToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelContactCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactCreateToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelContactCreateToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelContactCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelContactCreateToolWithToolCallMessagesItem([
