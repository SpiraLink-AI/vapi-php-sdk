...
final class TelnyxPhoneNumberHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return TelnyxPhoneNumberHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): TelnyxPhoneNumberHooksItem
    {
        return new TelnyxPhoneNumberHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return TelnyxPhoneNumberHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): TelnyxPhoneNumberHooksItem
    {
        return new TelnyxPhoneNumberHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
