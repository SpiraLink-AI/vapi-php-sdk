...
final class GoHighLevelContactCreateToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelContactCreateToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelContactCreateToolMessagesItem
    {
        return new GoHighLevelContactCreateToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelContactCreateToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelContactCreateToolMessagesItem
    {
        return new GoHighLevelContactCreateToolMessagesItem([
     ...
     * @return GoHighLevelContactCreateToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelContactCreateToolMessagesItem
    {
        return new GoHighLevelContactCreateToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelContactCreateToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelContactCreateToolMessagesItem
    {
        return new GoHighLevelContactCreateToolMessagesItem([
