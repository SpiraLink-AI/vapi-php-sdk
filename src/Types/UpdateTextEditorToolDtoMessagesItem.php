...
final class UpdateTextEditorToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateTextEditorToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateTextEditorToolDtoMessagesItem
    {
        return new UpdateTextEditorToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateTextEditorToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateTextEditorToolDtoMessagesItem
    {
        return new UpdateTextEditorToolDtoMessagesItem([
     ...
     * @return UpdateTextEditorToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateTextEditorToolDtoMessagesItem
    {
        return new UpdateTextEditorToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateTextEditorToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateTextEditorToolDtoMessagesItem
    {
        return new UpdateTextEditorToolDtoMessagesItem([
