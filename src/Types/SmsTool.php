...
final class SmsTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<SmsToolMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([SmsToolMessagesItem::class])]
     ...
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   messages?: ?array<SmsToolMessagesItem>,
