...
final class VapiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return VapiModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return VapiModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return VapiModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return VapiModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return VapiModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return VapiModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return VapiModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return VapiModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return VapiModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return VapiModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
     ...
     * @return VapiModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return VapiModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return VapiModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): VapiModelToolsItem
    {
        return new VapiModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
