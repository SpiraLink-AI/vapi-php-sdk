 ...
 */
final class ServerMessageConversationUpdatePhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageConversationUpdatePhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageConversationUpdatePhoneNumber
    {
     ...
     * @return ServerMessageConversationUpdatePhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageConversationUpdatePhoneNumber
    {
        return new ServerMessageConversationUpdatePhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageConversationUpdatePhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageConversationUpdatePhoneNumber
    {
        return new ServerMessageConversationUpdatePhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageConversationUpdatePhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageConversationUpdatePhoneNumber
    {
        return new ServerMessageConversationUpdatePhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageConversationUpdatePhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageConversationUpdatePhoneNumber
    {
        return new ServerMessageConversationUpdatePhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
