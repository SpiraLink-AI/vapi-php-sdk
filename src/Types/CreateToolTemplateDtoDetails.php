...
final class CreateToolTemplateDtoDetails extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function bash(CreateBashToolDto $bash): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function computer(CreateComputerToolDto $computer): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function endCall(CreateEndCallToolDto $endCall): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function function(CreateFunctionToolDto $function): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'function',
            'value' => $function,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function handoff(CreateHandoffToolDto $handoff): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function mcp(CreateMcpToolDto $mcp): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function query(CreateQueryToolDto $query): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'query',
            'value' => $query,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function sms(CreateSmsToolDto $sms): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return CreateToolTemplateDtoDetails
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): CreateToolTemplateDtoDetails
    {
        return new CreateToolTemplateDtoDetails([
            'type' => 'transferCall',
            'value' => $transferCall,
