...
final class UpdateApiRequestToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateApiRequestToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateApiRequestToolDtoMessagesItem
    {
        return new UpdateApiRequestToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateApiRequestToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateApiRequestToolDtoMessagesItem
    {
        return new UpdateApiRequestToolDtoMessagesItem([
     ...
     * @return UpdateApiRequestToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateApiRequestToolDtoMessagesItem
    {
        return new UpdateApiRequestToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateApiRequestToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateApiRequestToolDtoMessagesItem
    {
        return new UpdateApiRequestToolDtoMessagesItem([
