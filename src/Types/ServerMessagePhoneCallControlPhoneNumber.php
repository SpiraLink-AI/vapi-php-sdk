 ...
 */
final class ServerMessagePhoneCallControlPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessagePhoneCallControlPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessagePhoneCallControlPhoneNumber
    {
     ...
     * @return ServerMessagePhoneCallControlPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessagePhoneCallControlPhoneNumber
    {
        return new ServerMessagePhoneCallControlPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessagePhoneCallControlPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessagePhoneCallControlPhoneNumber
    {
        return new ServerMessagePhoneCallControlPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessagePhoneCallControlPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessagePhoneCallControlPhoneNumber
    {
        return new ServerMessagePhoneCallControlPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessagePhoneCallControlPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessagePhoneCallControlPhoneNumber
    {
        return new ServerMessagePhoneCallControlPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
