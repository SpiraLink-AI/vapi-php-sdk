...
final class CreateGhlToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateGhlToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateGhlToolDtoMessagesItem::class])]
