 ...
 */
final class ServerMessageHangPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageHangPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageHangPhoneNumber
    {
        return new ServerMessageHangPhoneNumber([
     ...
     * @return ServerMessageHangPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageHangPhoneNumber
    {
        return new ServerMessageHangPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageHangPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageHangPhoneNumber
    {
        return new ServerMessageHangPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageHangPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageHangPhoneNumber
    {
        return new ServerMessageHangPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageHangPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageHangPhoneNumber
    {
        return new ServerMessageHangPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
