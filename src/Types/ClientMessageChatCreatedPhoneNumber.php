 ...
 */
final class ClientMessageChatCreatedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageChatCreatedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageChatCreatedPhoneNumber
    {
        return new ClientMessageChatCreatedPhoneNumber([
     ...
     * @return ClientMessageChatCreatedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageChatCreatedPhoneNumber
    {
        return new ClientMessageChatCreatedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageChatCreatedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageChatCreatedPhoneNumber
    {
        return new ClientMessageChatCreatedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageChatCreatedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageChatCreatedPhoneNumber
    {
        return new ClientMessageChatCreatedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageChatCreatedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageChatCreatedPhoneNumber
    {
        return new ClientMessageChatCreatedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
