...
final class TransferSuccessfulToolUserEditable extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<TransferSuccessfulToolUserEditableMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([TransferSuccessfulToolUserEditableMessagesItem::class])]
