...
final class GoogleModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<GoogleModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([GoogleModelToolsItem::class])]
    public ?array $tools;
    ...
    /**
     * @var value-of<GoogleModelModel> $model This is the Google model that will be used.
     */
    #[JsonProperty('model')]
    public string $model;
     ...
     *
     * @var ?GoogleRealtimeConfig $realtimeConfig
     */
    #[JsonProperty('realtimeConfig')]
    public ?GoogleRealtimeConfig $realtimeConfig;
    ...
    /**
     * @param array{
     *   model: value-of<GoogleModelModel>,
     *   messages?: ?array<OpenAiMessage>,
     *   tools?: ?array<GoogleModelToolsItem>,
    ...
    public function __construct(
        ...
        $this->realtimeConfig = $values['realtimeConfig'] ?? null;
