 ...
 */
final class WorkflowUserEditableVoicemailDetection extends JsonSerializableType
{
    /**
     * @var (
     *    'google'
     ...
     * @return WorkflowUserEditableVoicemailDetection
     */
    public static function google(GoogleVoicemailDetectionPlan $google): WorkflowUserEditableVoicemailDetection
    {
        return new WorkflowUserEditableVoicemailDetection([
            'provider' => 'google',
            'value' => $google,
        ]);
    }
     ...
     * @return WorkflowUserEditableVoicemailDetection
     */
    public static function openai(OpenAiVoicemailDetectionPlan $openai): WorkflowUserEditableVoicemailDetection
    {
        return new WorkflowUserEditableVoicemailDetection([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return WorkflowUserEditableVoicemailDetection
     */
    public static function twilio(TwilioVoicemailDetectionPlan $twilio): WorkflowUserEditableVoicemailDetection
    {
        return new WorkflowUserEditableVoicemailDetection([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return WorkflowUserEditableVoicemailDetection
     */
    public static function vapi(VapiVoicemailDetectionPlan $vapi): WorkflowUserEditableVoicemailDetection
    {
        return new WorkflowUserEditableVoicemailDetection([
            'provider' => 'vapi',
            'value' => $vapi,
