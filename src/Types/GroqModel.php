...
final class GroqModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<GroqModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([GroqModelToolsItem::class])]
    public ?array $tools;
    ...
    /**
     * @var value-of<GroqModelModel> $model This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<GroqModelModel>,
     *   messages?: ?array<OpenAiMessage>,
     *   tools?: ?array<GroqModelToolsItem>,
