...
final class UpdateQueryToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateQueryToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateQueryToolDtoMessagesItem
    {
        return new UpdateQueryToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateQueryToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateQueryToolDtoMessagesItem
    {
        return new UpdateQueryToolDtoMessagesItem([
     ...
     * @return UpdateQueryToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateQueryToolDtoMessagesItem
    {
        return new UpdateQueryToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateQueryToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateQueryToolDtoMessagesItem
    {
        return new UpdateQueryToolDtoMessagesItem([
