 ...
 */
final class TransferPhoneNumberHookActionDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return TransferPhoneNumberHookActionDestination
     */
    public static function number(TransferDestinationNumber $number): TransferPhoneNumberHookActionDestination
    {
        return new TransferPhoneNumberHookActionDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return TransferPhoneNumberHookActionDestination
     */
    public static function sip(TransferDestinationSip $sip): TransferPhoneNumberHookActionDestination
    {
        return new TransferPhoneNumberHookActionDestination([
            'type' => 'sip',
            'value' => $sip,
