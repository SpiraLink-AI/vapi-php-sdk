...
final class UpdateEndCallToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateEndCallToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateEndCallToolDtoMessagesItem
    {
        return new UpdateEndCallToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateEndCallToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateEndCallToolDtoMessagesItem
    {
        return new UpdateEndCallToolDtoMessagesItem([
     ...
     * @return UpdateEndCallToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateEndCallToolDtoMessagesItem
    {
        return new UpdateEndCallToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateEndCallToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateEndCallToolDtoMessagesItem
    {
        return new UpdateEndCallToolDtoMessagesItem([
