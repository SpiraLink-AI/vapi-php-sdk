...
final class CreateTransferCallToolDtoDestinationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return CreateTransferCallToolDtoDestinationsItem
     */
    public static function assistant(TransferDestinationAssistant $assistant): CreateTransferCallToolDtoDestinationsItem
    {
        return new CreateTransferCallToolDtoDestinationsItem([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return CreateTransferCallToolDtoDestinationsItem
     */
    public static function number(TransferDestinationNumber $number): CreateTransferCallToolDtoDestinationsItem
    {
        return new CreateTransferCallToolDtoDestinationsItem([
            'type' => 'number',
            'value' => $number,
     ...
     * @return CreateTransferCallToolDtoDestinationsItem
     */
    public static function sip(TransferDestinationSip $sip): CreateTransferCallToolDtoDestinationsItem
    {
        return new CreateTransferCallToolDtoDestinationsItem([
            'type' => 'sip',
            'value' => $sip,
