 ...
 */
final class ServerMessageTranscriptPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageTranscriptPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageTranscriptPhoneNumber
    {
     ...
     * @return ServerMessageTranscriptPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageTranscriptPhoneNumber
    {
        return new ServerMessageTranscriptPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageTranscriptPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageTranscriptPhoneNumber
    {
        return new ServerMessageTranscriptPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageTranscriptPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageTranscriptPhoneNumber
    {
        return new ServerMessageTranscriptPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageTranscriptPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageTranscriptPhoneNumber
    {
        return new ServerMessageTranscriptPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
