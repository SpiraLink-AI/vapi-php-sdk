 ...
 */
final class ServerMessageResponseTransferDestinationRequestMessage extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return ServerMessageResponseTransferDestinationRequestMessage
     */
    public static function requestStart(ToolMessageStart $requestStart): ServerMessageResponseTransferDestinationRequestMessage
    {
        return new ServerMessageResponseTransferDestinationRequestMessage([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return ServerMessageResponseTransferDestinationRequestMessage
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): ServerMessageResponseTransferDestinationRequestMessage
    {
        return new ServerMessageResponseTransferDestinationRequestMessage([
     ...
     * @return ServerMessageResponseTransferDestinationRequestMessage
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): ServerMessageResponseTransferDestinationRequestMessage
    {
        return new ServerMessageResponseTransferDestinationRequestMessage([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return ServerMessageResponseTransferDestinationRequestMessage
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): ServerMessageResponseTransferDestinationRequestMessage
    {
        return new ServerMessageResponseTransferDestinationRequestMessage([
