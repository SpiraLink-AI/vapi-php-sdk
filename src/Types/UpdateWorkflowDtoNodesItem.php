...
final class UpdateWorkflowDtoNodesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'conversation'
     ...
     * @return UpdateWorkflowDtoNodesItem
     */
    public static function conversation(ConversationNode $conversation): UpdateWorkflowDtoNodesItem
    {
        return new UpdateWorkflowDtoNodesItem([
            'type' => 'conversation',
            'value' => $conversation,
        ]);
    }
     ...
     * @return UpdateWorkflowDtoNodesItem
     */
    public static function tool(ToolNode $tool): UpdateWorkflowDtoNodesItem
    {
        return new UpdateWorkflowDtoNodesItem([
            'type' => 'tool',
            'value' => $tool,
