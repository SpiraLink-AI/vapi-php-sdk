...
final class ByoPhoneNumberHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return ByoPhoneNumberHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): ByoPhoneNumberHooksItem
    {
        return new ByoPhoneNumberHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return ByoPhoneNumberHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): ByoPhoneNumberHooksItem
    {
        return new ByoPhoneNumberHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
