 ...
 */
final class ServerMessageStatusUpdatePhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageStatusUpdatePhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageStatusUpdatePhoneNumber
    {
        return new ServerMessageStatusUpdatePhoneNumber([
     ...
     * @return ServerMessageStatusUpdatePhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageStatusUpdatePhoneNumber
    {
        return new ServerMessageStatusUpdatePhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageStatusUpdatePhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageStatusUpdatePhoneNumber
    {
        return new ServerMessageStatusUpdatePhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageStatusUpdatePhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageStatusUpdatePhoneNumber
    {
        return new ServerMessageStatusUpdatePhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageStatusUpdatePhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageStatusUpdatePhoneNumber
    {
        return new ServerMessageStatusUpdatePhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
