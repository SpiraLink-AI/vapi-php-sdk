...
final class TextEditorToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return TextEditorToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): TextEditorToolWithToolCallMessagesItem
    {
        return new TextEditorToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return TextEditorToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): TextEditorToolWithToolCallMessagesItem
    {
        return new TextEditorToolWithToolCallMessagesItem([
     ...
     * @return TextEditorToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): TextEditorToolWithToolCallMessagesItem
    {
        return new TextEditorToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return TextEditorToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): TextEditorToolWithToolCallMessagesItem
    {
        return new TextEditorToolWithToolCallMessagesItem([
