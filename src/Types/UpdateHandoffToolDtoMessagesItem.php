...
final class UpdateHandoffToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateHandoffToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateHandoffToolDtoMessagesItem
    {
        return new UpdateHandoffToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateHandoffToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateHandoffToolDtoMessagesItem
    {
        return new UpdateHandoffToolDtoMessagesItem([
     ...
     * @return UpdateHandoffToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateHandoffToolDtoMessagesItem
    {
        return new UpdateHandoffToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateHandoffToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateHandoffToolDtoMessagesItem
    {
        return new UpdateHandoffToolDtoMessagesItem([
