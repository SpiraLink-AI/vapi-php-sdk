...
final class ServerMessageCallDeleteFailed extends JsonSerializableType
{
    /**
     * @var ?ServerMessageCallDeleteFailedPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
    #[JsonProperty('phoneNumber')]
    public ?ServerMessageCallDeleteFailedPhoneNumber $phoneNumber;
