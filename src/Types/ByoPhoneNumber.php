...
final class ByoPhoneNumber extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?ByoPhoneNumberFallbackDestination $fallbackDestination
     */
    #[JsonProperty('fallbackDestination')]
    public ?ByoPhoneNumberFallbackDestination $fallbackDestination;

    /**
     * @var ?array<ByoPhoneNumberHooksItem> $hooks This is the hooks that will be used for incoming calls to this phone number.
     */
    #[JsonProperty('hooks'), ArrayType([ByoPhoneNumberHooksItem::class])]
    public ?array $hooks;
    ...
    /**
     * @var ?value-of<ByoPhoneNumberStatus> $status This is the status of the phone number.
     */
    #[JsonProperty('status')]
     ...
     *   status?: ?value-of<ByoPhoneNumberStatus>,
     *   name?: ?string,
     *   assistantId?: ?string,
     *   workflowId?: ?string,
     *   squadId?: ?string,
