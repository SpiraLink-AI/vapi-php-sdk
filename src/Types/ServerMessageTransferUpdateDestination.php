 ...
 */
final class ServerMessageTransferUpdateDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return ServerMessageTransferUpdateDestination
     */
    public static function assistant(TransferDestinationAssistant $assistant): ServerMessageTransferUpdateDestination
    {
        return new ServerMessageTransferUpdateDestination([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return ServerMessageTransferUpdateDestination
     */
    public static function number(TransferDestinationNumber $number): ServerMessageTransferUpdateDestination
    {
        return new ServerMessageTransferUpdateDestination([
            'type' => 'number',
            'value' => $number,
     ...
     * @return ServerMessageTransferUpdateDestination
     */
    public static function sip(TransferDestinationSip $sip): ServerMessageTransferUpdateDestination
    {
        return new ServerMessageTransferUpdateDestination([
            'type' => 'sip',
            'value' => $sip,
