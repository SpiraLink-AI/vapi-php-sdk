...
final class CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
     ...
     * @return CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
