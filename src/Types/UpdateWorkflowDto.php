...
final class UpdateWorkflowDto extends JsonSerializableType
{
    /**
     * @var ?array<UpdateWorkflowDtoNodesItem> $nodes
     */
    #[JsonProperty('nodes'), ArrayType([UpdateWorkflowDtoNodesItem::class])]
    public ?array $nodes;
     ...
     *
     * @var ?UpdateWorkflowDtoModel $model
     */
    #[JsonProperty('model')]
    public ?UpdateWorkflowDtoModel $model;
     ...
     *
     * @var ?UpdateWorkflowDtoTranscriber $transcriber
     */
    #[JsonProperty('transcriber')]
    public ?UpdateWorkflowDtoTranscriber $transcriber;
     ...
     *
     * @var ?UpdateWorkflowDtoVoice $voice
     */
    #[JsonProperty('voice')]
    public ?UpdateWorkflowDtoVoice $voice;
     ...
     *
     * @var (
     *    value-of<UpdateWorkflowDtoBackgroundSoundZero>
     *   |string
    ...
    /**
     * @var ?array<UpdateWorkflowDtoCredentialsItem> $credentials These are dynamic credentials that will be used for the workflow calls. By default, all the credentials are available for use in the call but you can supplement an additional credentials using this. Dynamic credentials override existing credentials.
     */
    #[JsonProperty('credentials'), ArrayType([UpdateWorkflowDtoCredentialsItem::class])]
    ...
    /**
     * @param array{
     *   nodes?: ?array<UpdateWorkflowDtoNodesItem>,
     *   model?: ?UpdateWorkflowDtoModel,
     *   transcriber?: ?UpdateWorkflowDtoTranscriber,
     *   voice?: ?UpdateWorkflowDtoVoice,
