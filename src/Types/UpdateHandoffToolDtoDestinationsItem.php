...
final class UpdateHandoffToolDtoDestinationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return UpdateHandoffToolDtoDestinationsItem
     */
    public static function assistant(HandoffDestinationAssistant $assistant): UpdateHandoffToolDtoDestinationsItem
    {
        return new UpdateHandoffToolDtoDestinationsItem([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return UpdateHandoffToolDtoDestinationsItem
     */
    public static function dynamic(HandoffDestinationDynamic $dynamic): UpdateHandoffToolDtoDestinationsItem
    {
        return new UpdateHandoffToolDtoDestinationsItem([
            'type' => 'dynamic',
            'value' => $dynamic,
