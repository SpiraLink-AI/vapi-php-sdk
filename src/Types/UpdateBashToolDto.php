...
final class UpdateBashToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<UpdateBashToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([UpdateBashToolDtoMessagesItem::class])]
