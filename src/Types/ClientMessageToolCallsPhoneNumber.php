 ...
 */
final class ClientMessageToolCallsPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageToolCallsPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageToolCallsPhoneNumber
    {
        return new ClientMessageToolCallsPhoneNumber([
     ...
     * @return ClientMessageToolCallsPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageToolCallsPhoneNumber
    {
        return new ClientMessageToolCallsPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageToolCallsPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageToolCallsPhoneNumber
    {
        return new ClientMessageToolCallsPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageToolCallsPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageToolCallsPhoneNumber
    {
        return new ClientMessageToolCallsPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageToolCallsPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageToolCallsPhoneNumber
    {
        return new ClientMessageToolCallsPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
