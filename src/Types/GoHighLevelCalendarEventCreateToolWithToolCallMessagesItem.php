...
final class GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem([
     ...
     * @return GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem
    {
        return new GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem([
