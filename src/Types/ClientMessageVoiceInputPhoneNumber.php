 ...
 */
final class ClientMessageVoiceInputPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageVoiceInputPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageVoiceInputPhoneNumber
    {
        return new ClientMessageVoiceInputPhoneNumber([
     ...
     * @return ClientMessageVoiceInputPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageVoiceInputPhoneNumber
    {
        return new ClientMessageVoiceInputPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageVoiceInputPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageVoiceInputPhoneNumber
    {
        return new ClientMessageVoiceInputPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageVoiceInputPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageVoiceInputPhoneNumber
    {
        return new ClientMessageVoiceInputPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageVoiceInputPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageVoiceInputPhoneNumber
    {
        return new ClientMessageVoiceInputPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
