...
final class ImportVonagePhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return ImportVonagePhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): ImportVonagePhoneNumberDtoHooksItem
    {
        return new ImportVonagePhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return ImportVonagePhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): ImportVonagePhoneNumberDtoHooksItem
    {
        return new ImportVonagePhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
