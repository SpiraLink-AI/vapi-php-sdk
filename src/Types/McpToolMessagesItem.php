...
final class McpToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return McpToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): McpToolMessagesItem
    {
        return new McpToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return McpToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): McpToolMessagesItem
    {
        return new McpToolMessagesItem([
     ...
     * @return McpToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): McpToolMessagesItem
    {
        return new McpToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return McpToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): McpToolMessagesItem
    {
        return new McpToolMessagesItem([
