...
final class ServerMessageSessionCreated extends JsonSerializableType
{
    /**
     * @var ?ServerMessageSessionCreatedPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
