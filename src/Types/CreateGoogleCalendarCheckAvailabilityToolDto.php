...
final class CreateGoogleCalendarCheckAvailabilityToolDto extends JsonSerializableType
{
    /**
    ...
    /**
     * @param array{
     *   messages?: ?array<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>,
