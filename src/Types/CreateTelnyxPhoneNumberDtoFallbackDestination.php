 ...
 */
final class CreateTelnyxPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return CreateTelnyxPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): CreateTelnyxPhoneNumberDtoFallbackDestination
    {
        return new CreateTelnyxPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return CreateTelnyxPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): CreateTelnyxPhoneNumberDtoFallbackDestination
    {
        return new CreateTelnyxPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
