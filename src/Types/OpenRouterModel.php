...
final class OpenRouterModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<OpenRouterModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([OpenRouterModelToolsItem::class])]
    public ?array $tools;
     ...
     *   tools?: ?array<OpenRouterModelToolsItem>,
