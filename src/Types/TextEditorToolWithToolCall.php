...
final class TextEditorToolWithToolCall extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<TextEditorToolWithToolCallMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([TextEditorToolWithToolCallMessagesItem::class])]
     ...
     *   messages?: ?array<TextEditorToolWithToolCallMessagesItem>,
     *   server?: ?Server,
