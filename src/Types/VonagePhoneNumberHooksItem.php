...
final class VonagePhoneNumberHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return VonagePhoneNumberHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): VonagePhoneNumberHooksItem
    {
        return new VonagePhoneNumberHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return VonagePhoneNumberHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): VonagePhoneNumberHooksItem
    {
        return new VonagePhoneNumberHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
