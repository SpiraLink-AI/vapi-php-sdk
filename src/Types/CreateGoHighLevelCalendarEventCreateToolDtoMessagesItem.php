...
final class CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
     ...
     * @return CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem([
