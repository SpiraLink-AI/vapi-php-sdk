 ...
 */
final class TelnyxPhoneNumberFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return TelnyxPhoneNumberFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): TelnyxPhoneNumberFallbackDestination
    {
        return new TelnyxPhoneNumberFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return TelnyxPhoneNumberFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): TelnyxPhoneNumberFallbackDestination
    {
        return new TelnyxPhoneNumberFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
