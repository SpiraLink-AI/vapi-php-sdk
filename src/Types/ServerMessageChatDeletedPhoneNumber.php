 ...
 */
final class ServerMessageChatDeletedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageChatDeletedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageChatDeletedPhoneNumber
    {
        return new ServerMessageChatDeletedPhoneNumber([
     ...
     * @return ServerMessageChatDeletedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageChatDeletedPhoneNumber
    {
        return new ServerMessageChatDeletedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageChatDeletedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageChatDeletedPhoneNumber
    {
        return new ServerMessageChatDeletedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageChatDeletedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageChatDeletedPhoneNumber
    {
        return new ServerMessageChatDeletedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageChatDeletedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageChatDeletedPhoneNumber
    {
        return new ServerMessageChatDeletedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
