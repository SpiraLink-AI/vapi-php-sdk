...
final class FunctionToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return FunctionToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): FunctionToolMessagesItem
    {
        return new FunctionToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return FunctionToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): FunctionToolMessagesItem
    {
        return new FunctionToolMessagesItem([
     ...
     * @return FunctionToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): FunctionToolMessagesItem
    {
        return new FunctionToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return FunctionToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): FunctionToolMessagesItem
    {
        return new FunctionToolMessagesItem([
