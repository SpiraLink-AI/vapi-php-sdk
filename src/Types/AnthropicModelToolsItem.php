...
final class AnthropicModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return AnthropicModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return AnthropicModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
     ...
     * @return AnthropicModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return AnthropicModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): AnthropicModelToolsItem
    {
        return new AnthropicModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
