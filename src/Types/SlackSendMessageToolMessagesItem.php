...
final class SlackSendMessageToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return SlackSendMessageToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): SlackSendMessageToolMessagesItem
    {
        return new SlackSendMessageToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return SlackSendMessageToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): SlackSendMessageToolMessagesItem
    {
        return new SlackSendMessageToolMessagesItem([
     ...
     * @return SlackSendMessageToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): SlackSendMessageToolMessagesItem
    {
        return new SlackSendMessageToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return SlackSendMessageToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): SlackSendMessageToolMessagesItem
    {
        return new SlackSendMessageToolMessagesItem([
