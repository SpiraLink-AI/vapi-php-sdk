 ...
 */
final class CreateWorkflowDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): CreateWorkflowDtoTranscriber
    {
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function google(GoogleTranscriber $google): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateWorkflowDtoTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): CreateWorkflowDtoTranscriber
    {
        return new CreateWorkflowDtoTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
