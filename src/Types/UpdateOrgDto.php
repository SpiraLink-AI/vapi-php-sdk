...
final class UpdateOrgDto extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UpdateOrgDtoChannel> $channel This is the channel of the org. There is the cluster the API traffic for the org will be directed.
     */
     ...
     *   name?: ?string,
     *   channel?: ?value-of<UpdateOrgDtoChannel>,
     *   billingLimit?: ?float,
     *   server?: ?Server,
