...
final class WorkflowNodesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'conversation'
     ...
     * @return WorkflowNodesItem
     */
    public static function conversation(ConversationNode $conversation): WorkflowNodesItem
    {
        return new WorkflowNodesItem([
            'type' => 'conversation',
            'value' => $conversation,
        ]);
    }
     ...
     * @return WorkflowNodesItem
     */
    public static function tool(ToolNode $tool): WorkflowNodesItem
    {
        return new WorkflowNodesItem([
            'type' => 'tool',
            'value' => $tool,
