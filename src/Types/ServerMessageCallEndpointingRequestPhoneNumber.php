 ...
 */
final class ServerMessageCallEndpointingRequestPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageCallEndpointingRequestPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageCallEndpointingRequestPhoneNumber
    {
        return new ServerMessageCallEndpointingRequestPhoneNumber([
     ...
     * @return ServerMessageCallEndpointingRequestPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageCallEndpointingRequestPhoneNumber
    {
        return new ServerMessageCallEndpointingRequestPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageCallEndpointingRequestPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageCallEndpointingRequestPhoneNumber
    {
        return new ServerMessageCallEndpointingRequestPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageCallEndpointingRequestPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageCallEndpointingRequestPhoneNumber
    {
        return new ServerMessageCallEndpointingRequestPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageCallEndpointingRequestPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageCallEndpointingRequestPhoneNumber
    {
        return new ServerMessageCallEndpointingRequestPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
