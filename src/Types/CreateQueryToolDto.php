...
final class CreateQueryToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateQueryToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateQueryToolDtoMessagesItem::class])]
    ...
    /**
     * @param array{
     *   messages?: ?array<CreateQueryToolDtoMessagesItem>,
