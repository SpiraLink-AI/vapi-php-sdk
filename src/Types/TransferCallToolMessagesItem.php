...
final class TransferCallToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return TransferCallToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): TransferCallToolMessagesItem
    {
        return new TransferCallToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return TransferCallToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): TransferCallToolMessagesItem
    {
        return new TransferCallToolMessagesItem([
     ...
     * @return TransferCallToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): TransferCallToolMessagesItem
    {
        return new TransferCallToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return TransferCallToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): TransferCallToolMessagesItem
    {
        return new TransferCallToolMessagesItem([
