...
final class CreateMakeToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateMakeToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateMakeToolDtoMessagesItem
    {
        return new CreateMakeToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateMakeToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateMakeToolDtoMessagesItem
    {
        return new CreateMakeToolDtoMessagesItem([
     ...
     * @return CreateMakeToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateMakeToolDtoMessagesItem
    {
        return new CreateMakeToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateMakeToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateMakeToolDtoMessagesItem
    {
        return new CreateMakeToolDtoMessagesItem([
