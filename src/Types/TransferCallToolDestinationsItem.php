...
final class TransferCallToolDestinationsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return TransferCallToolDestinationsItem
     */
    public static function assistant(TransferDestinationAssistant $assistant): TransferCallToolDestinationsItem
    {
        return new TransferCallToolDestinationsItem([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return TransferCallToolDestinationsItem
     */
    public static function number(TransferDestinationNumber $number): TransferCallToolDestinationsItem
    {
        return new TransferCallToolDestinationsItem([
            'type' => 'number',
            'value' => $number,
     ...
     * @return TransferCallToolDestinationsItem
     */
    public static function sip(TransferDestinationSip $sip): TransferCallToolDestinationsItem
    {
        return new TransferCallToolDestinationsItem([
            'type' => 'sip',
            'value' => $sip,
