 ...
 */
final class ServerMessageCallDeletedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageCallDeletedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageCallDeletedPhoneNumber
    {
        return new ServerMessageCallDeletedPhoneNumber([
     ...
     * @return ServerMessageCallDeletedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageCallDeletedPhoneNumber
    {
        return new ServerMessageCallDeletedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageCallDeletedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageCallDeletedPhoneNumber
    {
        return new ServerMessageCallDeletedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageCallDeletedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageCallDeletedPhoneNumber
    {
        return new ServerMessageCallDeletedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageCallDeletedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageCallDeletedPhoneNumber
    {
        return new ServerMessageCallDeletedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
