 ...
 */
final class AssistantVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     */
    public static function azure(AzureVoice $azure): AssistantVoice
    {
     ...
     * @return AssistantVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return AssistantVoice
     */
    public static function customVoice(CustomVoice $customVoice): AssistantVoice
    {
        return new AssistantVoice([
     ...
     * @return AssistantVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return AssistantVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return AssistantVoice
     */
    public static function hume(HumeVoice $hume): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return AssistantVoice
     */
    public static function lmnt(LmntVoice $lmnt): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return AssistantVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return AssistantVoice
     */
    public static function openai(OpenAiVoice $openai): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantVoice
     */
    public static function playht(PlayHtVoice $playht): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return AssistantVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return AssistantVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): AssistantVoice
    {
        return new AssistantVoice([
     ...
     * @return AssistantVoice
     */
    public static function tavus(TavusVoice $tavus): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return AssistantVoice
     */
    public static function vapi(VapiVoice $vapi): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return AssistantVoice
     */
    public static function sesame(SesameVoice $sesame): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return AssistantVoice
     */
    public static function inworld(InworldVoice $inworld): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return AssistantVoice
     */
    public static function minimax(MinimaxVoice $minimax): AssistantVoice
    {
        return new AssistantVoice([
            'provider' => 'minimax',
            'value' => $minimax,
