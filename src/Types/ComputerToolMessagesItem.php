...
final class ComputerToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return ComputerToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): ComputerToolMessagesItem
    {
        return new ComputerToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return ComputerToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): ComputerToolMessagesItem
    {
        return new ComputerToolMessagesItem([
     ...
     * @return ComputerToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): ComputerToolMessagesItem
    {
        return new ComputerToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return ComputerToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): ComputerToolMessagesItem
    {
        return new ComputerToolMessagesItem([
