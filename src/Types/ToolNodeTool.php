 ...
 */
final class ToolNodeTool extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return ToolNodeTool
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return ToolNodeTool
     */
    public static function bash(CreateBashToolDto $bash): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ToolNodeTool
     */
    public static function computer(CreateComputerToolDto $computer): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ToolNodeTool
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return ToolNodeTool
     */
    public static function endCall(CreateEndCallToolDto $endCall): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return ToolNodeTool
     */
    public static function function(CreateFunctionToolDto $function): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'function',
            'value' => $function,
     ...
     * @return ToolNodeTool
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function handoff(CreateHandoffToolDto $handoff): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return ToolNodeTool
     */
    public static function mcp(CreateMcpToolDto $mcp): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return ToolNodeTool
     */
    public static function query(CreateQueryToolDto $query): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'query',
            'value' => $query,
     ...
     * @return ToolNodeTool
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): ToolNodeTool
    {
        return new ToolNodeTool([
     ...
     * @return ToolNodeTool
     */
    public static function sms(CreateSmsToolDto $sms): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return ToolNodeTool
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ToolNodeTool
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): ToolNodeTool
    {
        return new ToolNodeTool([
            'type' => 'transferCall',
            'value' => $transferCall,
