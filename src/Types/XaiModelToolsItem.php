...
final class XaiModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return XaiModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return XaiModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return XaiModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return XaiModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return XaiModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return XaiModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return XaiModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return XaiModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return XaiModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return XaiModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
     ...
     * @return XaiModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return XaiModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return XaiModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): XaiModelToolsItem
    {
        return new XaiModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
