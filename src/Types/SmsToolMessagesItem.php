...
final class SmsToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return SmsToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): SmsToolMessagesItem
    {
        return new SmsToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return SmsToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): SmsToolMessagesItem
    {
        return new SmsToolMessagesItem([
     ...
     * @return SmsToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): SmsToolMessagesItem
    {
        return new SmsToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return SmsToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): SmsToolMessagesItem
    {
        return new SmsToolMessagesItem([
