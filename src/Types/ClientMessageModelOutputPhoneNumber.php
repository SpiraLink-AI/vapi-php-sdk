 ...
 */
final class ClientMessageModelOutputPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageModelOutputPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageModelOutputPhoneNumber
    {
        return new ClientMessageModelOutputPhoneNumber([
     ...
     * @return ClientMessageModelOutputPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageModelOutputPhoneNumber
    {
        return new ClientMessageModelOutputPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageModelOutputPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageModelOutputPhoneNumber
    {
        return new ClientMessageModelOutputPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageModelOutputPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageModelOutputPhoneNumber
    {
        return new ClientMessageModelOutputPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageModelOutputPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageModelOutputPhoneNumber
    {
        return new ClientMessageModelOutputPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
