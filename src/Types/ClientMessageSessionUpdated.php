...
final class ClientMessageSessionUpdated extends JsonSerializableType
{
    /**
     * @var ?ClientMessageSessionUpdatedPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
