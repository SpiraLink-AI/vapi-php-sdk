...
final class UpdateOutputToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateOutputToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateOutputToolDtoMessagesItem
    {
        return new UpdateOutputToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateOutputToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateOutputToolDtoMessagesItem
    {
        return new UpdateOutputToolDtoMessagesItem([
     ...
     * @return UpdateOutputToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateOutputToolDtoMessagesItem
    {
        return new UpdateOutputToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateOutputToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateOutputToolDtoMessagesItem
    {
        return new UpdateOutputToolDtoMessagesItem([
