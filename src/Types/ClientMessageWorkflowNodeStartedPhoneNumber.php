 ...
 */
final class ClientMessageWorkflowNodeStartedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageWorkflowNodeStartedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageWorkflowNodeStartedPhoneNumber
    {
        return new ClientMessageWorkflowNodeStartedPhoneNumber([
     ...
     * @return ClientMessageWorkflowNodeStartedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageWorkflowNodeStartedPhoneNumber
    {
        return new ClientMessageWorkflowNodeStartedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageWorkflowNodeStartedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageWorkflowNodeStartedPhoneNumber
    {
        return new ClientMessageWorkflowNodeStartedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageWorkflowNodeStartedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageWorkflowNodeStartedPhoneNumber
    {
        return new ClientMessageWorkflowNodeStartedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageWorkflowNodeStartedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageWorkflowNodeStartedPhoneNumber
    {
        return new ClientMessageWorkflowNodeStartedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
