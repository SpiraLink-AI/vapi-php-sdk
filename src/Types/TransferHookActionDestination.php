 ...
 */
final class TransferHookActionDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return TransferHookActionDestination
     */
    public static function number(TransferDestinationNumber $number): TransferHookActionDestination
    {
        return new TransferHookActionDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return TransferHookActionDestination
     */
    public static function sip(TransferDestinationSip $sip): TransferHookActionDestination
    {
        return new TransferHookActionDestination([
            'type' => 'sip',
            'value' => $sip,
