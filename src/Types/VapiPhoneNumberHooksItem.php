...
final class VapiPhoneNumberHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return VapiPhoneNumberHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): VapiPhoneNumberHooksItem
    {
        return new VapiPhoneNumberHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return VapiPhoneNumberHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): VapiPhoneNumberHooksItem
    {
        return new VapiPhoneNumberHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
