 ...
 */
final class CreateByoPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return CreateByoPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): CreateByoPhoneNumberDtoFallbackDestination
    {
        return new CreateByoPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return CreateByoPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): CreateByoPhoneNumberDtoFallbackDestination
    {
        return new CreateByoPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
