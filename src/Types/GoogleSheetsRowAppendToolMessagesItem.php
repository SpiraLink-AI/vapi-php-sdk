...
final class GoogleSheetsRowAppendToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoogleSheetsRowAppendToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoogleSheetsRowAppendToolMessagesItem
    {
        return new GoogleSheetsRowAppendToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoogleSheetsRowAppendToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoogleSheetsRowAppendToolMessagesItem
    {
        return new GoogleSheetsRowAppendToolMessagesItem([
     ...
     * @return GoogleSheetsRowAppendToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoogleSheetsRowAppendToolMessagesItem
    {
        return new GoogleSheetsRowAppendToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoogleSheetsRowAppendToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoogleSheetsRowAppendToolMessagesItem
    {
        return new GoogleSheetsRowAppendToolMessagesItem([
