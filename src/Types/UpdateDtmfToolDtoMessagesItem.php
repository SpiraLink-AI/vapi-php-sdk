...
final class UpdateDtmfToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateDtmfToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateDtmfToolDtoMessagesItem
    {
        return new UpdateDtmfToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateDtmfToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateDtmfToolDtoMessagesItem
    {
        return new UpdateDtmfToolDtoMessagesItem([
     ...
     * @return UpdateDtmfToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateDtmfToolDtoMessagesItem
    {
        return new UpdateDtmfToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateDtmfToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateDtmfToolDtoMessagesItem
    {
        return new UpdateDtmfToolDtoMessagesItem([
