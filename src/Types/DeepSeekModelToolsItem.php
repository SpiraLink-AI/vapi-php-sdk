...
final class DeepSeekModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return DeepSeekModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): DeepSeekModelToolsItem
    {
        return new DeepSeekModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
