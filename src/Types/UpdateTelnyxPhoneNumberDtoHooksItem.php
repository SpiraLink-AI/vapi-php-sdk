...
final class UpdateTelnyxPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return UpdateTelnyxPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): UpdateTelnyxPhoneNumberDtoHooksItem
    {
        return new UpdateTelnyxPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return UpdateTelnyxPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): UpdateTelnyxPhoneNumberDtoHooksItem
    {
        return new UpdateTelnyxPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
