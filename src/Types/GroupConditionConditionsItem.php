...
final class GroupConditionConditionsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'regex'
     ...
     * @return GroupConditionConditionsItem
     */
    public static function regex(RegexCondition $regex): GroupConditionConditionsItem
    {
        return new GroupConditionConditionsItem([
            'type' => 'regex',
            'value' => $regex,
        ]);
    }
     ...
     * @return GroupConditionConditionsItem
     */
    public static function liquid(LiquidCondition $liquid): GroupConditionConditionsItem
    {
        return new GroupConditionConditionsItem([
            'type' => 'liquid',
            'value' => $liquid,
     ...
     * @return GroupConditionConditionsItem
     */
    public static function group(GroupCondition $group): GroupConditionConditionsItem
    {
        return new GroupConditionConditionsItem([
            'type' => 'group',
            'value' => $group,
