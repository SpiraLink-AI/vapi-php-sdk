 ...
 */
final class ClientMessageSessionDeletedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageSessionDeletedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageSessionDeletedPhoneNumber
    {
        return new ClientMessageSessionDeletedPhoneNumber([
     ...
     * @return ClientMessageSessionDeletedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageSessionDeletedPhoneNumber
    {
        return new ClientMessageSessionDeletedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageSessionDeletedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageSessionDeletedPhoneNumber
    {
        return new ClientMessageSessionDeletedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageSessionDeletedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageSessionDeletedPhoneNumber
    {
        return new ClientMessageSessionDeletedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageSessionDeletedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageSessionDeletedPhoneNumber
    {
        return new ClientMessageSessionDeletedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
