...
final class ServerMessageToolCallsToolWithToolCallListItem extends JsonSerializableType
{
    /**
     * @var (
     *    'function'
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function function(FunctionToolWithToolCall $function): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
            'type' => 'function',
            'value' => $function,
        ]);
    }
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function ghl(GhlToolWithToolCall $ghl): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
            'type' => 'ghl',
            'value' => $ghl,
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function make(MakeToolWithToolCall $make): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
            'type' => 'make',
            'value' => $make,
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function bash(BashToolWithToolCall $bash): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function computer(ComputerToolWithToolCall $computer): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function textEditor(TextEditorToolWithToolCall $textEditor): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return ServerMessageToolCallsToolWithToolCallListItem
     */
    public static function googleCalendarEventCreate(GoogleCalendarCreateEventToolWithToolCall $googleCalendarEventCreate): ServerMessageToolCallsToolWithToolCallListItem
    {
        return new ServerMessageToolCallsToolWithToolCallListItem([
