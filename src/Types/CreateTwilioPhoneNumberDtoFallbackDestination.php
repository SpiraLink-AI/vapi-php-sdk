 ...
 */
final class CreateTwilioPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return CreateTwilioPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): CreateTwilioPhoneNumberDtoFallbackDestination
    {
        return new CreateTwilioPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return CreateTwilioPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): CreateTwilioPhoneNumberDtoFallbackDestination
    {
        return new CreateTwilioPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
