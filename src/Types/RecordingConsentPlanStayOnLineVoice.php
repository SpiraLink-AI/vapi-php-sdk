 ...
 */
final class RecordingConsentPlanStayOnLineVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function azure(AzureVoice $azure): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'azure',
            'value' => $azure,
        ]);
    }
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function customVoice(CustomVoice $customVoice): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function hume(HumeVoice $hume): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function lmnt(LmntVoice $lmnt): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function openai(OpenAiVoice $openai): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function playht(PlayHtVoice $playht): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function tavus(TavusVoice $tavus): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function vapi(VapiVoice $vapi): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function sesame(SesameVoice $sesame): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function inworld(InworldVoice $inworld): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return RecordingConsentPlanStayOnLineVoice
     */
    public static function minimax(MinimaxVoice $minimax): RecordingConsentPlanStayOnLineVoice
    {
        return new RecordingConsentPlanStayOnLineVoice([
            'provider' => 'minimax',
            'value' => $minimax,
