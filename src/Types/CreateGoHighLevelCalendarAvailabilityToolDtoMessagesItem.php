...
final class CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
     ...
     * @return CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem
    {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem([
