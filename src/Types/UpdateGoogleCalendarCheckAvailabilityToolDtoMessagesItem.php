...
final class UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
     ...
     * @return UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem([
