...
final class HandoffToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return HandoffToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): HandoffToolMessagesItem
    {
        return new HandoffToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return HandoffToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): HandoffToolMessagesItem
    {
        return new HandoffToolMessagesItem([
     ...
     * @return HandoffToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): HandoffToolMessagesItem
    {
        return new HandoffToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return HandoffToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): HandoffToolMessagesItem
    {
        return new HandoffToolMessagesItem([
