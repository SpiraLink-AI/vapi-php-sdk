 ...
 */
final class ServerMessageVoiceRequestPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageVoiceRequestPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageVoiceRequestPhoneNumber
    {
     ...
     * @return ServerMessageVoiceRequestPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageVoiceRequestPhoneNumber
    {
        return new ServerMessageVoiceRequestPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageVoiceRequestPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageVoiceRequestPhoneNumber
    {
        return new ServerMessageVoiceRequestPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageVoiceRequestPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageVoiceRequestPhoneNumber
    {
        return new ServerMessageVoiceRequestPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageVoiceRequestPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageVoiceRequestPhoneNumber
    {
        return new ServerMessageVoiceRequestPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
