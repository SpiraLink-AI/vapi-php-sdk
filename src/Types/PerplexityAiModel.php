...
final class PerplexityAiModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<PerplexityAiModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([PerplexityAiModelToolsItem::class])]
    public ?array $tools;
     ...
     *   tools?: ?array<PerplexityAiModelToolsItem>,
