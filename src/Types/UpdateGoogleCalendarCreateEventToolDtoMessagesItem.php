...
final class UpdateGoogleCalendarCreateEventToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateGoogleCalendarCreateEventToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateGoogleCalendarCreateEventToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCreateEventToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateGoogleCalendarCreateEventToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateGoogleCalendarCreateEventToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCreateEventToolDtoMessagesItem([
     ...
     * @return UpdateGoogleCalendarCreateEventToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateGoogleCalendarCreateEventToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCreateEventToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateGoogleCalendarCreateEventToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateGoogleCalendarCreateEventToolDtoMessagesItem
    {
        return new UpdateGoogleCalendarCreateEventToolDtoMessagesItem([
