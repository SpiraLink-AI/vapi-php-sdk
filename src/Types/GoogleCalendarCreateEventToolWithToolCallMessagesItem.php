...
final class GoogleCalendarCreateEventToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoogleCalendarCreateEventToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoogleCalendarCreateEventToolWithToolCallMessagesItem
    {
        return new GoogleCalendarCreateEventToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoogleCalendarCreateEventToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoogleCalendarCreateEventToolWithToolCallMessagesItem
    {
        return new GoogleCalendarCreateEventToolWithToolCallMessagesItem([
     ...
     * @return GoogleCalendarCreateEventToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoogleCalendarCreateEventToolWithToolCallMessagesItem
    {
        return new GoogleCalendarCreateEventToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoogleCalendarCreateEventToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoogleCalendarCreateEventToolWithToolCallMessagesItem
    {
        return new GoogleCalendarCreateEventToolWithToolCallMessagesItem([
