 ...
 */
final class ClientMessageCallDeletedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageCallDeletedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageCallDeletedPhoneNumber
    {
        return new ClientMessageCallDeletedPhoneNumber([
     ...
     * @return ClientMessageCallDeletedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageCallDeletedPhoneNumber
    {
        return new ClientMessageCallDeletedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageCallDeletedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageCallDeletedPhoneNumber
    {
        return new ClientMessageCallDeletedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageCallDeletedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageCallDeletedPhoneNumber
    {
        return new ClientMessageCallDeletedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageCallDeletedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageCallDeletedPhoneNumber
    {
        return new ClientMessageCallDeletedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
