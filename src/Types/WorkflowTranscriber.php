 ...
 */
final class WorkflowTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     * @return WorkflowTranscriber
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
     ...
     * @return WorkflowTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return WorkflowTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
     ...
     * @return WorkflowTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return WorkflowTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return WorkflowTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return WorkflowTranscriber
     */
    public static function google(GoogleTranscriber $google): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return WorkflowTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
     ...
     * @return WorkflowTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
     ...
     * @return WorkflowTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return WorkflowTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): WorkflowTranscriber
    {
        return new WorkflowTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
