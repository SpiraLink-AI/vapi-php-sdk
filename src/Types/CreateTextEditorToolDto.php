...
final class CreateTextEditorToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateTextEditorToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateTextEditorToolDtoMessagesItem::class])]
