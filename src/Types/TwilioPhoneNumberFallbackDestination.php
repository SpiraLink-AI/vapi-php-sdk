 ...
 */
final class TwilioPhoneNumberFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return TwilioPhoneNumberFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): TwilioPhoneNumberFallbackDestination
    {
        return new TwilioPhoneNumberFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return TwilioPhoneNumberFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): TwilioPhoneNumberFallbackDestination
    {
        return new TwilioPhoneNumberFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
