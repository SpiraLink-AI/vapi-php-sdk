...
final class OpenRouterModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return OpenRouterModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): OpenRouterModelToolsItem
    {
        return new OpenRouterModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
