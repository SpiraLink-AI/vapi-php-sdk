...
final class ServerMessageCallDeleted extends JsonSerializableType
{
    /**
     * @var ?ServerMessageCallDeletedPhoneNumber $phoneNumber This is the phone number that the message is associated with.
     */
