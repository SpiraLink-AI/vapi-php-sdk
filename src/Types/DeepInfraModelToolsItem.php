...
final class DeepInfraModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return DeepInfraModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): DeepInfraModelToolsItem
    {
        return new DeepInfraModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
