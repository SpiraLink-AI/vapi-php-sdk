...
final class TwilioPhoneNumber extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?TwilioPhoneNumberFallbackDestination $fallbackDestination
     */
    #[JsonProperty('fallbackDestination')]
    public ?TwilioPhoneNumberFallbackDestination $fallbackDestination;

    /**
     * @var ?array<TwilioPhoneNumberHooksItem> $hooks This is the hooks that will be used for incoming calls to this phone number.
     */
    #[JsonProperty('hooks'), ArrayType([TwilioPhoneNumberHooksItem::class])]
    public ?array $hooks;
    ...
    /**
     * @var ?value-of<TwilioPhoneNumberStatus> $status This is the status of the phone number.
     */
    #[JsonProperty('status')]
     ...
     *   fallbackDestination?: ?TwilioPhoneNumberFallbackDestination,
     *   hooks?: ?array<TwilioPhoneNumberHooksItem>,
     *   smsEnabled?: ?bool,
     *   status?: ?value-of<TwilioPhoneNumberStatus>,
