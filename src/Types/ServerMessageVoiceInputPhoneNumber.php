 ...
 */
final class ServerMessageVoiceInputPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageVoiceInputPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageVoiceInputPhoneNumber
    {
     ...
     * @return ServerMessageVoiceInputPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageVoiceInputPhoneNumber
    {
        return new ServerMessageVoiceInputPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageVoiceInputPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageVoiceInputPhoneNumber
    {
        return new ServerMessageVoiceInputPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageVoiceInputPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageVoiceInputPhoneNumber
    {
        return new ServerMessageVoiceInputPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageVoiceInputPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageVoiceInputPhoneNumber
    {
        return new ServerMessageVoiceInputPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
