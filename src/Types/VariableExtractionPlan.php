...
final class VariableExtractionPlan extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<VariableExtractionAlias> $aliases
     */
    #[JsonProperty('aliases'), ArrayType([VariableExtractionAlias::class])]
    public ?array $aliases;

    /**
     * @param array{
     *   schema?: ?JsonSchema,
     *   aliases?: ?array<VariableExtractionAlias>,
     * } $values
     */
