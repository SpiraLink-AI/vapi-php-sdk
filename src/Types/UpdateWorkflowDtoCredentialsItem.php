...
final class UpdateWorkflowDtoCredentialsItem extends JsonSerializableType
{
    /**
     * @var (
     *    '11labs'
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function _11Labs(CreateElevenLabsCredentialDto $_11Labs): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => '11labs',
            'value' => $_11Labs,
        ]);
    }
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function anthropic(CreateAnthropicCredentialDto $anthropic): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'anthropic',
            'value' => $anthropic,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function anyscale(CreateAnyscaleCredentialDto $anyscale): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function assemblyAi(CreateAssemblyAiCredentialDto $assemblyAi): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function azureOpenai(CreateAzureOpenAiCredentialDto $azureOpenai): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function azure(CreateAzureCredentialDto $azure): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function byoSipTrunk(CreateByoSipTrunkCredentialDto $byoSipTrunk): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function cartesia(CreateCartesiaCredentialDto $cartesia): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function cerebras(CreateCerebrasCredentialDto $cerebras): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function cloudflare(CreateCloudflareCredentialDto $cloudflare): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'cloudflare',
            'value' => $cloudflare,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function customLlm(CreateCustomLlmCredentialDto $customLlm): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'custom-llm',
            'value' => $customLlm,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function deepgram(CreateDeepgramCredentialDto $deepgram): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function deepinfra(CreateDeepInfraCredentialDto $deepinfra): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'deepinfra',
            'value' => $deepinfra,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function deepSeek(CreateDeepSeekCredentialDto $deepSeek): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function gcp(CreateGcpCredentialDto $gcp): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'gcp',
            'value' => $gcp,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function gladia(CreateGladiaCredentialDto $gladia): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function gohighlevel(CreateGoHighLevelCredentialDto $gohighlevel): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function google(CreateGoogleCredentialDto $google): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function groq(CreateGroqCredentialDto $groq): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function inflectionAi(CreateInflectionAiCredentialDto $inflectionAi): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function langfuse(CreateLangfuseCredentialDto $langfuse): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'langfuse',
            'value' => $langfuse,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function lmnt(CreateLmntCredentialDto $lmnt): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function make(CreateMakeCredentialDto $make): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'make',
            'value' => $make,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function openai(CreateOpenAiCredentialDto $openai): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function openrouter(CreateOpenRouterCredentialDto $openrouter): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function perplexityAi(CreatePerplexityAiCredentialDto $perplexityAi): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function playht(CreatePlayHtCredentialDto $playht): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function rimeAi(CreateRimeAiCredentialDto $rimeAi): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function runpod(CreateRunpodCredentialDto $runpod): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'runpod',
            'value' => $runpod,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function s3(CreateS3CredentialDto $s3): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 's3',
            'value' => $s3,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function supabase(CreateSupabaseCredentialDto $supabase): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'supabase',
            'value' => $supabase,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function smallestAi(CreateSmallestAiCredentialDto $smallestAi): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function tavus(CreateTavusCredentialDto $tavus): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function togetherAi(CreateTogetherAiCredentialDto $togetherAi): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function twilio(CreateTwilioCredentialDto $twilio): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function vonage(CreateVonageCredentialDto $vonage): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function webhook(CreateWebhookCredentialDto $webhook): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'webhook',
            'value' => $webhook,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function customCredential(CreateCustomCredentialDto $customCredential): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function xai(CreateXAiCredentialDto $xai): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function neuphonic(CreateNeuphonicCredentialDto $neuphonic): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function hume(CreateHumeCredentialDto $hume): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function mistral(CreateMistralCredentialDto $mistral): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'mistral',
            'value' => $mistral,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function speechmatics(CreateSpeechmaticsCredentialDto $speechmatics): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function trieve(CreateTrieveCredentialDto $trieve): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'trieve',
            'value' => $trieve,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function googleCalendarOauth2Client(CreateGoogleCalendarOAuth2ClientCredentialDto $googleCalendarOauth2Client): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function googleCalendarOauth2Authorization(CreateGoogleCalendarOAuth2AuthorizationCredentialDto $googleCalendarOauth2Authorization): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function googleSheetsOauth2Authorization(CreateGoogleSheetsOAuth2AuthorizationCredentialDto $googleSheetsOauth2Authorization): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function slackOauth2Authorization(CreateSlackOAuth2AuthorizationCredentialDto $slackOauth2Authorization): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function ghlOauth2Authorization(CreateGoHighLevelMcpCredentialDto $ghlOauth2Authorization): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function inworld(CreateInworldCredentialDto $inworld): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return UpdateWorkflowDtoCredentialsItem
     */
    public static function minimax(CreateMinimaxCredentialDto $minimax): UpdateWorkflowDtoCredentialsItem
    {
        return new UpdateWorkflowDtoCredentialsItem([
            'provider' => 'minimax',
            'value' => $minimax,
