...
final class HandoffTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<HandoffToolDestinationsItem> $destinations
     */
    #[JsonProperty('destinations'), ArrayType([HandoffToolDestinationsItem::class])]
