 ...
 */
final class ClientMessageCallDeleteFailedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageCallDeleteFailedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageCallDeleteFailedPhoneNumber
    {
        return new ClientMessageCallDeleteFailedPhoneNumber([
     ...
     * @return ClientMessageCallDeleteFailedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageCallDeleteFailedPhoneNumber
    {
        return new ClientMessageCallDeleteFailedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageCallDeleteFailedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageCallDeleteFailedPhoneNumber
    {
        return new ClientMessageCallDeleteFailedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageCallDeleteFailedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageCallDeleteFailedPhoneNumber
    {
        return new ClientMessageCallDeleteFailedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageCallDeleteFailedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageCallDeleteFailedPhoneNumber
    {
        return new ClientMessageCallDeleteFailedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
