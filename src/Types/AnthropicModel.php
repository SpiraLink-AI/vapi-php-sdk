...
final class AnthropicModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<AnthropicModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([AnthropicModelToolsItem::class])]
    public ?array $tools;
    ...
    /**
     * @var value-of<AnthropicModelModel> $model The specific Anthropic/Claude model that will be used.
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<AnthropicModelModel>,
     *   messages?: ?array<OpenAiMessage>,
     *   tools?: ?array<AnthropicModelToolsItem>,
