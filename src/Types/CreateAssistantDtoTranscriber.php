 ...
 */
final class CreateAssistantDtoTranscriber extends JsonSerializableType
{
    /**
     * @var (
     *    'assembly-ai'
     ...
     */
    public static function assemblyAi(AssemblyAiTranscriber $assemblyAi): CreateAssistantDtoTranscriber
    {
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function azure(AzureSpeechTranscriber $azure): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function customTranscriber(CustomTranscriber $customTranscriber): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function deepgram(DeepgramTranscriber $deepgram): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function _11Labs(ElevenLabsTranscriber $_11Labs): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function gladia(GladiaTranscriber $gladia): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function google(GoogleTranscriber $google): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function speechmatics(SpeechmaticsTranscriber $speechmatics): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function talkscriber(TalkscriberTranscriber $talkscriber): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function openai(OpenAiTranscriber $openai): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return CreateAssistantDtoTranscriber
     */
    public static function cartesia(CartesiaTranscriber $cartesia): CreateAssistantDtoTranscriber
    {
        return new CreateAssistantDtoTranscriber([
            'provider' => 'cartesia',
            'value' => $cartesia,
