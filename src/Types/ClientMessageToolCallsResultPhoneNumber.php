 ...
 */
final class ClientMessageToolCallsResultPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageToolCallsResultPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageToolCallsResultPhoneNumber
    {
        return new ClientMessageToolCallsResultPhoneNumber([
     ...
     * @return ClientMessageToolCallsResultPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageToolCallsResultPhoneNumber
    {
        return new ClientMessageToolCallsResultPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageToolCallsResultPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageToolCallsResultPhoneNumber
    {
        return new ClientMessageToolCallsResultPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageToolCallsResultPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageToolCallsResultPhoneNumber
    {
        return new ClientMessageToolCallsResultPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageToolCallsResultPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageToolCallsResultPhoneNumber
    {
        return new ClientMessageToolCallsResultPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
