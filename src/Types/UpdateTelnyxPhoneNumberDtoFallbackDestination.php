 ...
 */
final class UpdateTelnyxPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return UpdateTelnyxPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): UpdateTelnyxPhoneNumberDtoFallbackDestination
    {
        return new UpdateTelnyxPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return UpdateTelnyxPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): UpdateTelnyxPhoneNumberDtoFallbackDestination
    {
        return new UpdateTelnyxPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
