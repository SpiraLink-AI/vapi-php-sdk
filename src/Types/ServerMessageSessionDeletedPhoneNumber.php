 ...
 */
final class ServerMessageSessionDeletedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageSessionDeletedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageSessionDeletedPhoneNumber
    {
        return new ServerMessageSessionDeletedPhoneNumber([
     ...
     * @return ServerMessageSessionDeletedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageSessionDeletedPhoneNumber
    {
        return new ServerMessageSessionDeletedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageSessionDeletedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageSessionDeletedPhoneNumber
    {
        return new ServerMessageSessionDeletedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageSessionDeletedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageSessionDeletedPhoneNumber
    {
        return new ServerMessageSessionDeletedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageSessionDeletedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageSessionDeletedPhoneNumber
    {
        return new ServerMessageSessionDeletedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
