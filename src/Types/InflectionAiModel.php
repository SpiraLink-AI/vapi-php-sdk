...
final class InflectionAiModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<InflectionAiModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([InflectionAiModelToolsItem::class])]
    public ?array $tools;
