...
final class CreateHandoffToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateHandoffToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateHandoffToolDtoMessagesItem::class])]
     ...
     *
     * @var ?array<CreateHandoffToolDtoDestinationsItem> $destinations
     */
    #[JsonProperty('destinations'), ArrayType([CreateHandoffToolDtoDestinationsItem::class])]
