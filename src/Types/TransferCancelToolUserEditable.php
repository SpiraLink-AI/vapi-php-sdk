...
final class TransferCancelToolUserEditable extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<TransferCancelToolUserEditableMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([TransferCancelToolUserEditableMessagesItem::class])]
