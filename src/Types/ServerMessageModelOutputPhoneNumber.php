 ...
 */
final class ServerMessageModelOutputPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageModelOutputPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageModelOutputPhoneNumber
    {
     ...
     * @return ServerMessageModelOutputPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageModelOutputPhoneNumber
    {
        return new ServerMessageModelOutputPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageModelOutputPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageModelOutputPhoneNumber
    {
        return new ServerMessageModelOutputPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageModelOutputPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageModelOutputPhoneNumber
    {
        return new ServerMessageModelOutputPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageModelOutputPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageModelOutputPhoneNumber
    {
        return new ServerMessageModelOutputPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
