...
final class EndCallToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return EndCallToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): EndCallToolMessagesItem
    {
        return new EndCallToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return EndCallToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): EndCallToolMessagesItem
    {
        return new EndCallToolMessagesItem([
     ...
     * @return EndCallToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): EndCallToolMessagesItem
    {
        return new EndCallToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return EndCallToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): EndCallToolMessagesItem
    {
        return new EndCallToolMessagesItem([
