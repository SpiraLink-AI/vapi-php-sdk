...
final class WorkflowCredentialsItem extends JsonSerializableType
{
    /**
     * @var (
     *    '11labs'
     ...
     * @return WorkflowCredentialsItem
     */
    public static function _11Labs(CreateElevenLabsCredentialDto $_11Labs): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => '11labs',
            'value' => $_11Labs,
        ]);
    }
     ...
     * @return WorkflowCredentialsItem
     */
    public static function anthropic(CreateAnthropicCredentialDto $anthropic): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'anthropic',
            'value' => $anthropic,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function anyscale(CreateAnyscaleCredentialDto $anyscale): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function assemblyAi(CreateAssemblyAiCredentialDto $assemblyAi): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function azureOpenai(CreateAzureOpenAiCredentialDto $azureOpenai): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function azure(CreateAzureCredentialDto $azure): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'azure',
            'value' => $azure,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function byoSipTrunk(CreateByoSipTrunkCredentialDto $byoSipTrunk): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function cartesia(CreateCartesiaCredentialDto $cartesia): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function cerebras(CreateCerebrasCredentialDto $cerebras): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function cloudflare(CreateCloudflareCredentialDto $cloudflare): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'cloudflare',
            'value' => $cloudflare,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function customLlm(CreateCustomLlmCredentialDto $customLlm): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'custom-llm',
            'value' => $customLlm,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function deepgram(CreateDeepgramCredentialDto $deepgram): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function deepinfra(CreateDeepInfraCredentialDto $deepinfra): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'deepinfra',
            'value' => $deepinfra,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function deepSeek(CreateDeepSeekCredentialDto $deepSeek): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function gcp(CreateGcpCredentialDto $gcp): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'gcp',
            'value' => $gcp,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function gladia(CreateGladiaCredentialDto $gladia): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'gladia',
            'value' => $gladia,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function gohighlevel(CreateGoHighLevelCredentialDto $gohighlevel): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function google(CreateGoogleCredentialDto $google): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function groq(CreateGroqCredentialDto $groq): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function inflectionAi(CreateInflectionAiCredentialDto $inflectionAi): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function langfuse(CreateLangfuseCredentialDto $langfuse): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'langfuse',
            'value' => $langfuse,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function lmnt(CreateLmntCredentialDto $lmnt): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function make(CreateMakeCredentialDto $make): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'make',
            'value' => $make,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function openai(CreateOpenAiCredentialDto $openai): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function openrouter(CreateOpenRouterCredentialDto $openrouter): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function perplexityAi(CreatePerplexityAiCredentialDto $perplexityAi): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function playht(CreatePlayHtCredentialDto $playht): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function rimeAi(CreateRimeAiCredentialDto $rimeAi): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function runpod(CreateRunpodCredentialDto $runpod): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'runpod',
            'value' => $runpod,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function s3(CreateS3CredentialDto $s3): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 's3',
            'value' => $s3,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function supabase(CreateSupabaseCredentialDto $supabase): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'supabase',
            'value' => $supabase,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function smallestAi(CreateSmallestAiCredentialDto $smallestAi): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function tavus(CreateTavusCredentialDto $tavus): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function togetherAi(CreateTogetherAiCredentialDto $togetherAi): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function twilio(CreateTwilioCredentialDto $twilio): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function vonage(CreateVonageCredentialDto $vonage): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function webhook(CreateWebhookCredentialDto $webhook): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'webhook',
            'value' => $webhook,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function customCredential(CreateCustomCredentialDto $customCredential): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function xai(CreateXAiCredentialDto $xai): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'xai',
            'value' => $xai,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function neuphonic(CreateNeuphonicCredentialDto $neuphonic): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function hume(CreateHumeCredentialDto $hume): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function mistral(CreateMistralCredentialDto $mistral): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'mistral',
            'value' => $mistral,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function speechmatics(CreateSpeechmaticsCredentialDto $speechmatics): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function trieve(CreateTrieveCredentialDto $trieve): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'trieve',
            'value' => $trieve,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function googleCalendarOauth2Client(CreateGoogleCalendarOAuth2ClientCredentialDto $googleCalendarOauth2Client): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function googleCalendarOauth2Authorization(CreateGoogleCalendarOAuth2AuthorizationCredentialDto $googleCalendarOauth2Authorization): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function googleSheetsOauth2Authorization(CreateGoogleSheetsOAuth2AuthorizationCredentialDto $googleSheetsOauth2Authorization): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function slackOauth2Authorization(CreateSlackOAuth2AuthorizationCredentialDto $slackOauth2Authorization): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function ghlOauth2Authorization(CreateGoHighLevelMcpCredentialDto $ghlOauth2Authorization): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
     ...
     * @return WorkflowCredentialsItem
     */
    public static function inworld(CreateInworldCredentialDto $inworld): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return WorkflowCredentialsItem
     */
    public static function minimax(CreateMinimaxCredentialDto $minimax): WorkflowCredentialsItem
    {
        return new WorkflowCredentialsItem([
            'provider' => 'minimax',
            'value' => $minimax,
