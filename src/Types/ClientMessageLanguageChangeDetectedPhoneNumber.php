 ...
 */
final class ClientMessageLanguageChangeDetectedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageLanguageChangeDetectedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageLanguageChangeDetectedPhoneNumber
    {
        return new ClientMessageLanguageChangeDetectedPhoneNumber([
     ...
     * @return ClientMessageLanguageChangeDetectedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageLanguageChangeDetectedPhoneNumber
    {
        return new ClientMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageLanguageChangeDetectedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageLanguageChangeDetectedPhoneNumber
    {
        return new ClientMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageLanguageChangeDetectedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageLanguageChangeDetectedPhoneNumber
    {
        return new ClientMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageLanguageChangeDetectedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageLanguageChangeDetectedPhoneNumber
    {
        return new ClientMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
