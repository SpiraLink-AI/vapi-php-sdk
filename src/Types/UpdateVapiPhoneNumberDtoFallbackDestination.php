 ...
 */
final class UpdateVapiPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return UpdateVapiPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): UpdateVapiPhoneNumberDtoFallbackDestination
    {
        return new UpdateVapiPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return UpdateVapiPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): UpdateVapiPhoneNumberDtoFallbackDestination
    {
        return new UpdateVapiPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
