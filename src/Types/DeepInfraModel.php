...
final class DeepInfraModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<DeepInfraModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([DeepInfraModelToolsItem::class])]
    public ?array $tools;
