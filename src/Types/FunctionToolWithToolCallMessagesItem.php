...
final class FunctionToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return FunctionToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): FunctionToolWithToolCallMessagesItem
    {
        return new FunctionToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return FunctionToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): FunctionToolWithToolCallMessagesItem
    {
        return new FunctionToolWithToolCallMessagesItem([
     ...
     * @return FunctionToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): FunctionToolWithToolCallMessagesItem
    {
        return new FunctionToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return FunctionToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): FunctionToolWithToolCallMessagesItem
    {
        return new FunctionToolWithToolCallMessagesItem([
