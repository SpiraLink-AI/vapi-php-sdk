 ...
 */
final class ClientMessageSessionCreatedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageSessionCreatedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageSessionCreatedPhoneNumber
    {
        return new ClientMessageSessionCreatedPhoneNumber([
     ...
     * @return ClientMessageSessionCreatedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageSessionCreatedPhoneNumber
    {
        return new ClientMessageSessionCreatedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageSessionCreatedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageSessionCreatedPhoneNumber
    {
        return new ClientMessageSessionCreatedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageSessionCreatedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageSessionCreatedPhoneNumber
    {
        return new ClientMessageSessionCreatedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageSessionCreatedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageSessionCreatedPhoneNumber
    {
        return new ClientMessageSessionCreatedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
