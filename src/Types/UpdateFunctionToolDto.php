...
final class UpdateFunctionToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<UpdateFunctionToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([UpdateFunctionToolDtoMessagesItem::class])]
