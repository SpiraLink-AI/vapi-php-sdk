...
final class SlackSendMessageTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<SlackSendMessageToolMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([SlackSendMessageToolMessagesItem::class])]
     ...
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   messages?: ?array<SlackSendMessageToolMessagesItem>,
