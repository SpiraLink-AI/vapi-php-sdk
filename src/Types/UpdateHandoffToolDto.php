...
final class UpdateHandoffToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<UpdateHandoffToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([UpdateHandoffToolDtoMessagesItem::class])]
     ...
     *
     * @var ?array<UpdateHandoffToolDtoDestinationsItem> $destinations
     */
    #[JsonProperty('destinations'), ArrayType([UpdateHandoffToolDtoDestinationsItem::class])]
    ...
    /**
     * @param array{
     *   messages?: ?array<UpdateHandoffToolDtoMessagesItem>,
     *   destinations?: ?array<UpdateHandoffToolDtoDestinationsItem>,
