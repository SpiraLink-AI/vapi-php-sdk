...
final class BashToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return BashToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): BashToolMessagesItem
    {
        return new BashToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return BashToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): BashToolMessagesItem
    {
        return new BashToolMessagesItem([
     ...
     * @return BashToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): BashToolMessagesItem
    {
        return new BashToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return BashToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): BashToolMessagesItem
    {
        return new BashToolMessagesItem([
