...
final class RimeAiVoice extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<RimeAiVoiceModel> $model This is the model that will be used. Defaults to 'arcana' when not specified.
     */
    #[JsonProperty('model')]
    public ?string $model;
     ...
     * ),
     *   cachingEnabled?: ?bool,
     *   model?: ?value-of<RimeAiVoiceModel>,
     *   speed?: ?float,
