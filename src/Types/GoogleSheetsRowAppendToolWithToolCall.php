...
final class GoogleSheetsRowAppendToolWithToolCall extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<GoogleSheetsRowAppendToolWithToolCallMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([GoogleSheetsRowAppendToolWithToolCallMessagesItem::class])]
