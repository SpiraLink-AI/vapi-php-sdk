 ...
 */
final class ServerMessageEndOfCallReportPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageEndOfCallReportPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageEndOfCallReportPhoneNumber
    {
        return new ServerMessageEndOfCallReportPhoneNumber([
     ...
     * @return ServerMessageEndOfCallReportPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageEndOfCallReportPhoneNumber
    {
        return new ServerMessageEndOfCallReportPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageEndOfCallReportPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageEndOfCallReportPhoneNumber
    {
        return new ServerMessageEndOfCallReportPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageEndOfCallReportPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageEndOfCallReportPhoneNumber
    {
        return new ServerMessageEndOfCallReportPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageEndOfCallReportPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageEndOfCallReportPhoneNumber
    {
        return new ServerMessageEndOfCallReportPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
