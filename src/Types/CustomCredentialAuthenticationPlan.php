 ...
 */
final class CustomCredentialAuthenticationPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'oauth2'
     ...
     * @return CustomCredentialAuthenticationPlan
     */
    public static function oauth2(OAuth2AuthenticationPlan $oauth2): CustomCredentialAuthenticationPlan
    {
        return new CustomCredentialAuthenticationPlan([
            'type' => 'oauth2',
            'value' => $oauth2,
        ]);
    }
     ...
     * @return CustomCredentialAuthenticationPlan
     */
    public static function hmac(HmacAuthenticationPlan $hmac): CustomCredentialAuthenticationPlan
    {
        return new CustomCredentialAuthenticationPlan([
            'type' => 'hmac',
            'value' => $hmac,
     ...
     * @return CustomCredentialAuthenticationPlan
     */
    public static function bearer(BearerAuthenticationPlan $bearer): CustomCredentialAuthenticationPlan
    {
        return new CustomCredentialAuthenticationPlan([
            'type' => 'bearer',
            'value' => $bearer,
