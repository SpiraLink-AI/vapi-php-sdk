 ...
 */
final class CreateVonagePhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return CreateVonagePhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): CreateVonagePhoneNumberDtoFallbackDestination
    {
        return new CreateVonagePhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return CreateVonagePhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): CreateVonagePhoneNumberDtoFallbackDestination
    {
        return new CreateVonagePhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
