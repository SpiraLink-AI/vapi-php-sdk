...
final class CreateSmsToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateSmsToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateSmsToolDtoMessagesItem
    {
        return new CreateSmsToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateSmsToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateSmsToolDtoMessagesItem
    {
        return new CreateSmsToolDtoMessagesItem([
     ...
     * @return CreateSmsToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateSmsToolDtoMessagesItem
    {
        return new CreateSmsToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateSmsToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateSmsToolDtoMessagesItem
    {
        return new CreateSmsToolDtoMessagesItem([
