 ...
 */
final class VonagePhoneNumberFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return VonagePhoneNumberFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): VonagePhoneNumberFallbackDestination
    {
        return new VonagePhoneNumberFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return VonagePhoneNumberFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): VonagePhoneNumberFallbackDestination
    {
        return new VonagePhoneNumberFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
