 ...
 */
final class ServerMessageChatCreatedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageChatCreatedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageChatCreatedPhoneNumber
    {
        return new ServerMessageChatCreatedPhoneNumber([
     ...
     * @return ServerMessageChatCreatedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageChatCreatedPhoneNumber
    {
        return new ServerMessageChatCreatedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageChatCreatedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageChatCreatedPhoneNumber
    {
        return new ServerMessageChatCreatedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageChatCreatedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageChatCreatedPhoneNumber
    {
        return new ServerMessageChatCreatedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageChatCreatedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageChatCreatedPhoneNumber
    {
        return new ServerMessageChatCreatedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
