 ...
 */
final class WorkflowVoicemailDetection extends JsonSerializableType
{
    /**
     * @var (
     *    'google'
     ...
     * @return WorkflowVoicemailDetection
     */
    public static function google(GoogleVoicemailDetectionPlan $google): WorkflowVoicemailDetection
    {
        return new WorkflowVoicemailDetection([
            'provider' => 'google',
            'value' => $google,
        ]);
    }
     ...
     * @return WorkflowVoicemailDetection
     */
    public static function openai(OpenAiVoicemailDetectionPlan $openai): WorkflowVoicemailDetection
    {
        return new WorkflowVoicemailDetection([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return WorkflowVoicemailDetection
     */
    public static function twilio(TwilioVoicemailDetectionPlan $twilio): WorkflowVoicemailDetection
    {
        return new WorkflowVoicemailDetection([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return WorkflowVoicemailDetection
     */
    public static function vapi(VapiVoicemailDetectionPlan $vapi): WorkflowVoicemailDetection
    {
        return new WorkflowVoicemailDetection([
            'provider' => 'vapi',
            'value' => $vapi,
