...
final class CreateTwilioPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return CreateTwilioPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): CreateTwilioPhoneNumberDtoHooksItem
    {
        return new CreateTwilioPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return CreateTwilioPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): CreateTwilioPhoneNumberDtoHooksItem
    {
        return new CreateTwilioPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
