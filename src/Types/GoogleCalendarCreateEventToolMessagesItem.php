...
final class GoogleCalendarCreateEventToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoogleCalendarCreateEventToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoogleCalendarCreateEventToolMessagesItem
    {
        return new GoogleCalendarCreateEventToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoogleCalendarCreateEventToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoogleCalendarCreateEventToolMessagesItem
    {
        return new GoogleCalendarCreateEventToolMessagesItem([
     ...
     * @return GoogleCalendarCreateEventToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoogleCalendarCreateEventToolMessagesItem
    {
        return new GoogleCalendarCreateEventToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoogleCalendarCreateEventToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoogleCalendarCreateEventToolMessagesItem
    {
        return new GoogleCalendarCreateEventToolMessagesItem([
