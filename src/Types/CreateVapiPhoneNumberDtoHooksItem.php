...
final class CreateVapiPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return CreateVapiPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): CreateVapiPhoneNumberDtoHooksItem
    {
        return new CreateVapiPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return CreateVapiPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): CreateVapiPhoneNumberDtoHooksItem
    {
        return new CreateVapiPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
