...
final class FunctionCallHookAction extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<FunctionCallHookActionMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([FunctionCallHookActionMessagesItem::class])]
