...
final class CreateGoHighLevelContactCreateToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactCreateToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactCreateToolDtoMessagesItem([
     ...
     * @return CreateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactCreateToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateGoHighLevelContactCreateToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateGoHighLevelContactCreateToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactCreateToolDtoMessagesItem([
