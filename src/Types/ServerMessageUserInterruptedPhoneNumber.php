 ...
 */
final class ServerMessageUserInterruptedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageUserInterruptedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageUserInterruptedPhoneNumber
    {
        return new ServerMessageUserInterruptedPhoneNumber([
     ...
     * @return ServerMessageUserInterruptedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageUserInterruptedPhoneNumber
    {
        return new ServerMessageUserInterruptedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageUserInterruptedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageUserInterruptedPhoneNumber
    {
        return new ServerMessageUserInterruptedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageUserInterruptedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageUserInterruptedPhoneNumber
    {
        return new ServerMessageUserInterruptedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageUserInterruptedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageUserInterruptedPhoneNumber
    {
        return new ServerMessageUserInterruptedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
