 ...
 */
final class ConversationNodeModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     */
    public static function openai(WorkflowOpenAiModel $openai): ConversationNodeModel
    {
     ...
     * @return ConversationNodeModel
     */
    public static function anthropic(WorkflowAnthropicModel $anthropic): ConversationNodeModel
    {
        return new ConversationNodeModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
     ...
     * @return ConversationNodeModel
     */
    public static function google(WorkflowGoogleModel $google): ConversationNodeModel
    {
        return new ConversationNodeModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return ConversationNodeModel
     */
    public static function customLlm(WorkflowCustomModel $customLlm): ConversationNodeModel
    {
        return new ConversationNodeModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
