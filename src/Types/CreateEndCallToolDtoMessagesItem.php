...
final class CreateEndCallToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateEndCallToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateEndCallToolDtoMessagesItem
    {
        return new CreateEndCallToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateEndCallToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateEndCallToolDtoMessagesItem
    {
        return new CreateEndCallToolDtoMessagesItem([
     ...
     * @return CreateEndCallToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateEndCallToolDtoMessagesItem
    {
        return new CreateEndCallToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateEndCallToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateEndCallToolDtoMessagesItem
    {
        return new CreateEndCallToolDtoMessagesItem([
