...
final class CreateGoHighLevelContactGetToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactGetToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactGetToolDtoMessagesItem([
     ...
     * @return CreateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactGetToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateGoHighLevelContactGetToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateGoHighLevelContactGetToolDtoMessagesItem
    {
        return new CreateGoHighLevelContactGetToolDtoMessagesItem([
