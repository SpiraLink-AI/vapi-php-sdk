...
final class TransferCancelToolUserEditableMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return TransferCancelToolUserEditableMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): TransferCancelToolUserEditableMessagesItem
    {
        return new TransferCancelToolUserEditableMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return TransferCancelToolUserEditableMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): TransferCancelToolUserEditableMessagesItem
    {
        return new TransferCancelToolUserEditableMessagesItem([
     ...
     * @return TransferCancelToolUserEditableMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): TransferCancelToolUserEditableMessagesItem
    {
        return new TransferCancelToolUserEditableMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return TransferCancelToolUserEditableMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): TransferCancelToolUserEditableMessagesItem
    {
        return new TransferCancelToolUserEditableMessagesItem([
