...
final class ComputerToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return ComputerToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): ComputerToolWithToolCallMessagesItem
    {
        return new ComputerToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return ComputerToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): ComputerToolWithToolCallMessagesItem
    {
        return new ComputerToolWithToolCallMessagesItem([
     ...
     * @return ComputerToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): ComputerToolWithToolCallMessagesItem
    {
        return new ComputerToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return ComputerToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): ComputerToolWithToolCallMessagesItem
    {
        return new ComputerToolWithToolCallMessagesItem([
