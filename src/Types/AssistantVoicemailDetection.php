 ...
 */
final class AssistantVoicemailDetection extends JsonSerializableType
{
    /**
     * @var (
     *    'google'
     ...
     * @return AssistantVoicemailDetection
     */
    public static function google(GoogleVoicemailDetectionPlan $google): AssistantVoicemailDetection
    {
        return new AssistantVoicemailDetection([
            'provider' => 'google',
            'value' => $google,
        ]);
    }
     ...
     * @return AssistantVoicemailDetection
     */
    public static function openai(OpenAiVoicemailDetectionPlan $openai): AssistantVoicemailDetection
    {
        return new AssistantVoicemailDetection([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return AssistantVoicemailDetection
     */
    public static function twilio(TwilioVoicemailDetectionPlan $twilio): AssistantVoicemailDetection
    {
        return new AssistantVoicemailDetection([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return AssistantVoicemailDetection
     */
    public static function vapi(VapiVoicemailDetectionPlan $vapi): AssistantVoicemailDetection
    {
        return new AssistantVoicemailDetection([
            'provider' => 'vapi',
            'value' => $vapi,
