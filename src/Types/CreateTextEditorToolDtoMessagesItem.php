...
final class CreateTextEditorToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateTextEditorToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateTextEditorToolDtoMessagesItem
    {
        return new CreateTextEditorToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateTextEditorToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateTextEditorToolDtoMessagesItem
    {
        return new CreateTextEditorToolDtoMessagesItem([
     ...
     * @return CreateTextEditorToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateTextEditorToolDtoMessagesItem
    {
        return new CreateTextEditorToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateTextEditorToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateTextEditorToolDtoMessagesItem
    {
        return new CreateTextEditorToolDtoMessagesItem([
