 ...
 */
final class ClientMessageUserInterruptedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ClientMessageUserInterruptedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ClientMessageUserInterruptedPhoneNumber
    {
        return new ClientMessageUserInterruptedPhoneNumber([
     ...
     * @return ClientMessageUserInterruptedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ClientMessageUserInterruptedPhoneNumber
    {
        return new ClientMessageUserInterruptedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ClientMessageUserInterruptedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ClientMessageUserInterruptedPhoneNumber
    {
        return new ClientMessageUserInterruptedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ClientMessageUserInterruptedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ClientMessageUserInterruptedPhoneNumber
    {
        return new ClientMessageUserInterruptedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ClientMessageUserInterruptedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ClientMessageUserInterruptedPhoneNumber
    {
        return new ClientMessageUserInterruptedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
