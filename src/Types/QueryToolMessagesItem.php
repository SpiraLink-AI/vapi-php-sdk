...
final class QueryToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return QueryToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): QueryToolMessagesItem
    {
        return new QueryToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return QueryToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): QueryToolMessagesItem
    {
        return new QueryToolMessagesItem([
     ...
     * @return QueryToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): QueryToolMessagesItem
    {
        return new QueryToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return QueryToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): QueryToolMessagesItem
    {
        return new QueryToolMessagesItem([
