...
final class TextEditorToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return TextEditorToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): TextEditorToolMessagesItem
    {
        return new TextEditorToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return TextEditorToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): TextEditorToolMessagesItem
    {
        return new TextEditorToolMessagesItem([
     ...
     * @return TextEditorToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): TextEditorToolMessagesItem
    {
        return new TextEditorToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return TextEditorToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): TextEditorToolMessagesItem
    {
        return new TextEditorToolMessagesItem([
