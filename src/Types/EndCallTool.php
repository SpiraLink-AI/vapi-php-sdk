...
final class EndCallTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<EndCallToolMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([EndCallToolMessagesItem::class])]
     ...
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   messages?: ?array<EndCallToolMessagesItem>,
