 ...
 */
final class WebhookCredentialAuthenticationPlan extends JsonSerializableType
{
    /**
     * @var (
     *    'oauth2'
     ...
     * @return WebhookCredentialAuthenticationPlan
     */
    public static function oauth2(OAuth2AuthenticationPlan $oauth2): WebhookCredentialAuthenticationPlan
    {
        return new WebhookCredentialAuthenticationPlan([
            'type' => 'oauth2',
            'value' => $oauth2,
        ]);
    }
     ...
     * @return WebhookCredentialAuthenticationPlan
     */
    public static function hmac(HmacAuthenticationPlan $hmac): WebhookCredentialAuthenticationPlan
    {
        return new WebhookCredentialAuthenticationPlan([
            'type' => 'hmac',
            'value' => $hmac,
     ...
     * @return WebhookCredentialAuthenticationPlan
     */
    public static function bearer(BearerAuthenticationPlan $bearer): WebhookCredentialAuthenticationPlan
    {
        return new WebhookCredentialAuthenticationPlan([
            'type' => 'bearer',
            'value' => $bearer,
