 ...
 */
final class PhoneNumberHookCallEndingDo extends JsonSerializableType
{
    /**
     * @var (
     *    'transfer'
     ...
     * @return PhoneNumberHookCallEndingDo
     */
    public static function transfer(TransferPhoneNumberHookAction $transfer): PhoneNumberHookCallEndingDo
    {
        return new PhoneNumberHookCallEndingDo([
            'type' => 'transfer',
            'value' => $transfer,
        ]);
    }
     ...
     * @return PhoneNumberHookCallEndingDo
     */
    public static function say(SayPhoneNumberHookAction $say): PhoneNumberHookCallEndingDo
    {
        return new PhoneNumberHookCallEndingDo([
            'type' => 'say',
            'value' => $say,
