...
final class CreateDtmfToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateDtmfToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateDtmfToolDtoMessagesItem
    {
        return new CreateDtmfToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateDtmfToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateDtmfToolDtoMessagesItem
    {
        return new CreateDtmfToolDtoMessagesItem([
     ...
     * @return CreateDtmfToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateDtmfToolDtoMessagesItem
    {
        return new CreateDtmfToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateDtmfToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateDtmfToolDtoMessagesItem
    {
        return new CreateDtmfToolDtoMessagesItem([
