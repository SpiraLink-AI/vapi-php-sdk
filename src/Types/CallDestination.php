 ...
 */
final class CallDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     */
    public static function number(TransferDestinationNumber $number): CallDestination
    {
        return new CallDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return CallDestination
     */
    public static function sip(TransferDestinationSip $sip): CallDestination
    {
        return new CallDestination([
            'type' => 'sip',
            'value' => $sip,
