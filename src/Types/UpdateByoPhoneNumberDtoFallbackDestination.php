 ...
 */
final class UpdateByoPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return UpdateByoPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): UpdateByoPhoneNumberDtoFallbackDestination
    {
        return new UpdateByoPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return UpdateByoPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): UpdateByoPhoneNumberDtoFallbackDestination
    {
        return new UpdateByoPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
