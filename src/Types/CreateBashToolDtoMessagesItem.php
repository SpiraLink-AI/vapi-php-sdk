...
final class CreateBashToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateBashToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateBashToolDtoMessagesItem
    {
        return new CreateBashToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateBashToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateBashToolDtoMessagesItem
    {
        return new CreateBashToolDtoMessagesItem([
     ...
     * @return CreateBashToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateBashToolDtoMessagesItem
    {
        return new CreateBashToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateBashToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateBashToolDtoMessagesItem
    {
        return new CreateBashToolDtoMessagesItem([
