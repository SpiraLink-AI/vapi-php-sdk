...
final class CreateComputerToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return CreateComputerToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): CreateComputerToolDtoMessagesItem
    {
        return new CreateComputerToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return CreateComputerToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): CreateComputerToolDtoMessagesItem
    {
        return new CreateComputerToolDtoMessagesItem([
     ...
     * @return CreateComputerToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): CreateComputerToolDtoMessagesItem
    {
        return new CreateComputerToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return CreateComputerToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): CreateComputerToolDtoMessagesItem
    {
        return new CreateComputerToolDtoMessagesItem([
