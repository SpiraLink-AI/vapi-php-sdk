...
final class CerebrasModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     * @return CerebrasModelToolsItem
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'apiRequest',
            'value' => $apiRequest,
        ]);
    }
     ...
     * @return CerebrasModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
     ...
     * @return CerebrasModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return CerebrasModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): CerebrasModelToolsItem
    {
        return new CerebrasModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
