 ...
 */
final class UpdateVonagePhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return UpdateVonagePhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): UpdateVonagePhoneNumberDtoFallbackDestination
    {
        return new UpdateVonagePhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return UpdateVonagePhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): UpdateVonagePhoneNumberDtoFallbackDestination
    {
        return new UpdateVonagePhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
