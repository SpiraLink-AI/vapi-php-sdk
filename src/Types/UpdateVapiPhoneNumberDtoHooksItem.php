...
final class UpdateVapiPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return UpdateVapiPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): UpdateVapiPhoneNumberDtoHooksItem
    {
        return new UpdateVapiPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return UpdateVapiPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): UpdateVapiPhoneNumberDtoHooksItem
    {
        return new UpdateVapiPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
