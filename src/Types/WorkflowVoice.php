 ...
 */
final class WorkflowVoice extends JsonSerializableType
{
    /**
     * @var (
     *    'azure'
     ...
     * @return WorkflowVoice
     */
    public static function azure(AzureVoice $azure): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'azure',
            'value' => $azure,
        ]);
    }
     ...
     * @return WorkflowVoice
     */
    public static function cartesia(CartesiaVoice $cartesia): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'cartesia',
            'value' => $cartesia,
     ...
     * @return WorkflowVoice
     */
    public static function customVoice(CustomVoice $customVoice): WorkflowVoice
    {
        return new WorkflowVoice([
     ...
     * @return WorkflowVoice
     */
    public static function deepgram(DeepgramVoice $deepgram): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'deepgram',
            'value' => $deepgram,
     ...
     * @return WorkflowVoice
     */
    public static function _11Labs(ElevenLabsVoice $_11Labs): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => '11labs',
            'value' => $_11Labs,
     ...
     * @return WorkflowVoice
     */
    public static function hume(HumeVoice $hume): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'hume',
            'value' => $hume,
     ...
     * @return WorkflowVoice
     */
    public static function lmnt(LmntVoice $lmnt): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'lmnt',
            'value' => $lmnt,
     ...
     * @return WorkflowVoice
     */
    public static function neuphonic(NeuphonicVoice $neuphonic): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'neuphonic',
            'value' => $neuphonic,
     ...
     * @return WorkflowVoice
     */
    public static function openai(OpenAiVoice $openai): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return WorkflowVoice
     */
    public static function playht(PlayHtVoice $playht): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'playht',
            'value' => $playht,
     ...
     * @return WorkflowVoice
     */
    public static function rimeAi(RimeAiVoice $rimeAi): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'rime-ai',
            'value' => $rimeAi,
     ...
     * @return WorkflowVoice
     */
    public static function smallestAi(SmallestAiVoice $smallestAi): WorkflowVoice
    {
        return new WorkflowVoice([
     ...
     * @return WorkflowVoice
     */
    public static function tavus(TavusVoice $tavus): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'tavus',
            'value' => $tavus,
     ...
     * @return WorkflowVoice
     */
    public static function vapi(VapiVoice $vapi): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return WorkflowVoice
     */
    public static function sesame(SesameVoice $sesame): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'sesame',
            'value' => $sesame,
     ...
     * @return WorkflowVoice
     */
    public static function inworld(InworldVoice $inworld): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'inworld',
            'value' => $inworld,
     ...
     * @return WorkflowVoice
     */
    public static function minimax(MinimaxVoice $minimax): WorkflowVoice
    {
        return new WorkflowVoice([
            'provider' => 'minimax',
            'value' => $minimax,
