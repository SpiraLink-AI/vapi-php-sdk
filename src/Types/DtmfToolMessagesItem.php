...
final class DtmfToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return DtmfToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): DtmfToolMessagesItem
    {
        return new DtmfToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return DtmfToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): DtmfToolMessagesItem
    {
        return new DtmfToolMessagesItem([
     ...
     * @return DtmfToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): DtmfToolMessagesItem
    {
        return new DtmfToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return DtmfToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): DtmfToolMessagesItem
    {
        return new DtmfToolMessagesItem([
