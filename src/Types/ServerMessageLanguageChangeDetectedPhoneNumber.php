 ...
 */
final class ServerMessageLanguageChangeDetectedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageLanguageChangeDetectedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageLanguageChangeDetectedPhoneNumber
    {
        return new ServerMessageLanguageChangeDetectedPhoneNumber([
     ...
     * @return ServerMessageLanguageChangeDetectedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageLanguageChangeDetectedPhoneNumber
    {
        return new ServerMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageLanguageChangeDetectedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageLanguageChangeDetectedPhoneNumber
    {
        return new ServerMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageLanguageChangeDetectedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageLanguageChangeDetectedPhoneNumber
    {
        return new ServerMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageLanguageChangeDetectedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageLanguageChangeDetectedPhoneNumber
    {
        return new ServerMessageLanguageChangeDetectedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
