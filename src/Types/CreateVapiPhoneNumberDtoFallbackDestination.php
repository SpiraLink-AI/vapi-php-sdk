 ...
 */
final class CreateVapiPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return CreateVapiPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): CreateVapiPhoneNumberDtoFallbackDestination
    {
        return new CreateVapiPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return CreateVapiPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): CreateVapiPhoneNumberDtoFallbackDestination
    {
        return new CreateVapiPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
