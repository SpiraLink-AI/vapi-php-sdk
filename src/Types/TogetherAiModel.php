...
final class TogetherAiModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<TogetherAiModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([TogetherAiModelToolsItem::class])]
    public ?array $tools;
     ...
     *   tools?: ?array<TogetherAiModelToolsItem>,
