...
final class AnyscaleModelToolsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'apiRequest'
     ...
     */
    public static function apiRequest(CreateApiRequestToolDto $apiRequest): AnyscaleModelToolsItem
    {
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function bash(CreateBashToolDto $bash): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'bash',
            'value' => $bash,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function computer(CreateComputerToolDto $computer): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'computer',
            'value' => $computer,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function dtmf(CreateDtmfToolDto $dtmf): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'dtmf',
            'value' => $dtmf,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function endCall(CreateEndCallToolDto $endCall): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'endCall',
            'value' => $endCall,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function function(CreateFunctionToolDto $function): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'function',
            'value' => $function,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function gohighlevelCalendarAvailabilityCheck(CreateGoHighLevelCalendarAvailabilityToolDto $gohighlevelCalendarAvailabilityCheck): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto $gohighlevelCalendarEventCreate): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto $gohighlevelContactCreate): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function gohighlevelContactGet(CreateGoHighLevelContactGetToolDto $gohighlevelContactGet): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function googleCalendarAvailabilityCheck(CreateGoogleCalendarCheckAvailabilityToolDto $googleCalendarAvailabilityCheck): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto $googleCalendarEventCreate): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto $googleSheetsRowAppend): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function handoff(CreateHandoffToolDto $handoff): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'handoff',
            'value' => $handoff,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function mcp(CreateMcpToolDto $mcp): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'mcp',
            'value' => $mcp,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function query(CreateQueryToolDto $query): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'query',
            'value' => $query,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function slackMessageSend(CreateSlackSendMessageToolDto $slackMessageSend): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function sms(CreateSmsToolDto $sms): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'sms',
            'value' => $sms,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function textEditor(CreateTextEditorToolDto $textEditor): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'textEditor',
            'value' => $textEditor,
     ...
     * @return AnyscaleModelToolsItem
     */
    public static function transferCall(CreateTransferCallToolDto $transferCall): AnyscaleModelToolsItem
    {
        return new AnyscaleModelToolsItem([
            'type' => 'transferCall',
            'value' => $transferCall,
