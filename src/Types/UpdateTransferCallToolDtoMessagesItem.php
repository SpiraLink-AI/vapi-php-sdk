...
final class UpdateTransferCallToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateTransferCallToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateTransferCallToolDtoMessagesItem
    {
        return new UpdateTransferCallToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateTransferCallToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateTransferCallToolDtoMessagesItem
    {
        return new UpdateTransferCallToolDtoMessagesItem([
     ...
     * @return UpdateTransferCallToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateTransferCallToolDtoMessagesItem
    {
        return new UpdateTransferCallToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateTransferCallToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateTransferCallToolDtoMessagesItem
    {
        return new UpdateTransferCallToolDtoMessagesItem([
