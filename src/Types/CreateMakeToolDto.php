...
final class CreateMakeToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateMakeToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateMakeToolDtoMessagesItem::class])]
