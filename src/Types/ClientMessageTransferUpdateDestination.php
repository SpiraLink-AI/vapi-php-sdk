 ...
 */
final class ClientMessageTransferUpdateDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return ClientMessageTransferUpdateDestination
     */
    public static function assistant(TransferDestinationAssistant $assistant): ClientMessageTransferUpdateDestination
    {
        return new ClientMessageTransferUpdateDestination([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return ClientMessageTransferUpdateDestination
     */
    public static function number(TransferDestinationNumber $number): ClientMessageTransferUpdateDestination
    {
        return new ClientMessageTransferUpdateDestination([
            'type' => 'number',
            'value' => $number,
     ...
     * @return ClientMessageTransferUpdateDestination
     */
    public static function sip(TransferDestinationSip $sip): ClientMessageTransferUpdateDestination
    {
        return new ClientMessageTransferUpdateDestination([
            'type' => 'sip',
            'value' => $sip,
