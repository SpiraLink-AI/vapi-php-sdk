...
final class CreateComputerToolDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<CreateComputerToolDtoMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([CreateComputerToolDtoMessagesItem::class])]
     ...
     *   messages?: ?array<CreateComputerToolDtoMessagesItem>,
     *   server?: ?Server,
     *   displayNumber?: ?float,
