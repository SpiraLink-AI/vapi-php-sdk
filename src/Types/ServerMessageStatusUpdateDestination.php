 ...
 */
final class ServerMessageStatusUpdateDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ServerMessageStatusUpdateDestination
     */
    public static function number(TransferDestinationNumber $number): ServerMessageStatusUpdateDestination
    {
        return new ServerMessageStatusUpdateDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ServerMessageStatusUpdateDestination
     */
    public static function sip(TransferDestinationSip $sip): ServerMessageStatusUpdateDestination
    {
        return new ServerMessageStatusUpdateDestination([
            'type' => 'sip',
            'value' => $sip,
