 ...
 */
final class ServerMessageTransferUpdatePhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageTransferUpdatePhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageTransferUpdatePhoneNumber
    {
        return new ServerMessageTransferUpdatePhoneNumber([
     ...
     * @return ServerMessageTransferUpdatePhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageTransferUpdatePhoneNumber
    {
        return new ServerMessageTransferUpdatePhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageTransferUpdatePhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageTransferUpdatePhoneNumber
    {
        return new ServerMessageTransferUpdatePhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageTransferUpdatePhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageTransferUpdatePhoneNumber
    {
        return new ServerMessageTransferUpdatePhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageTransferUpdatePhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageTransferUpdatePhoneNumber
    {
        return new ServerMessageTransferUpdatePhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
