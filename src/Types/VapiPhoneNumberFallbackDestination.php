 ...
 */
final class VapiPhoneNumberFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return VapiPhoneNumberFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): VapiPhoneNumberFallbackDestination
    {
        return new VapiPhoneNumberFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return VapiPhoneNumberFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): VapiPhoneNumberFallbackDestination
    {
        return new VapiPhoneNumberFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
