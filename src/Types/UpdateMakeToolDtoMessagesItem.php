...
final class UpdateMakeToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateMakeToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateMakeToolDtoMessagesItem
    {
        return new UpdateMakeToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateMakeToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateMakeToolDtoMessagesItem
    {
        return new UpdateMakeToolDtoMessagesItem([
     ...
     * @return UpdateMakeToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateMakeToolDtoMessagesItem
    {
        return new UpdateMakeToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateMakeToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateMakeToolDtoMessagesItem
    {
        return new UpdateMakeToolDtoMessagesItem([
