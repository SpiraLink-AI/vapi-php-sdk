...
final class GoogleSheetsRowAppendTool extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<GoogleSheetsRowAppendToolMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([GoogleSheetsRowAppendToolMessagesItem::class])]
     ...
     *   createdAt: DateTime,
     *   updatedAt: DateTime,
     *   messages?: ?array<GoogleSheetsRowAppendToolMessagesItem>,
