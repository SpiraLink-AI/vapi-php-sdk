...
final class UpdateTwilioPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return UpdateTwilioPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): UpdateTwilioPhoneNumberDtoHooksItem
    {
        return new UpdateTwilioPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return UpdateTwilioPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): UpdateTwilioPhoneNumberDtoHooksItem
    {
        return new UpdateTwilioPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
