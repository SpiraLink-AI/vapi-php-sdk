...
final class UpdateVonagePhoneNumberDto extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?UpdateVonagePhoneNumberDtoFallbackDestination $fallbackDestination
     */
    #[JsonProperty('fallbackDestination')]
    public ?UpdateVonagePhoneNumberDtoFallbackDestination $fallbackDestination;

    /**
     * @var ?array<UpdateVonagePhoneNumberDtoHooksItem> $hooks This is the hooks that will be used for incoming calls to this phone number.
     */
    #[JsonProperty('hooks'), ArrayType([UpdateVonagePhoneNumberDtoHooksItem::class])]
    public ?array $hooks;
    ...
    /**
     * @param array{
     *   fallbackDestination?: ?UpdateVonagePhoneNumberDtoFallbackDestination,
     *   hooks?: ?array<UpdateVonagePhoneNumberDtoHooksItem>,
     *   name?: ?string,
     *   assistantId?: ?string,
     *   workflowId?: ?string,
     *   squadId?: ?string,
