...
final class UpdateBashToolDtoMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return UpdateBashToolDtoMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): UpdateBashToolDtoMessagesItem
    {
        return new UpdateBashToolDtoMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return UpdateBashToolDtoMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): UpdateBashToolDtoMessagesItem
    {
        return new UpdateBashToolDtoMessagesItem([
     ...
     * @return UpdateBashToolDtoMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): UpdateBashToolDtoMessagesItem
    {
        return new UpdateBashToolDtoMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return UpdateBashToolDtoMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): UpdateBashToolDtoMessagesItem
    {
        return new UpdateBashToolDtoMessagesItem([
