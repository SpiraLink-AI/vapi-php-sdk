 ...
 */
final class ImportTwilioPhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ImportTwilioPhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): ImportTwilioPhoneNumberDtoFallbackDestination
    {
        return new ImportTwilioPhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ImportTwilioPhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): ImportTwilioPhoneNumberDtoFallbackDestination
    {
        return new ImportTwilioPhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
