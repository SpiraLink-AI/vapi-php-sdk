 ...
 */
final class ServerMessageSessionCreatedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageSessionCreatedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageSessionCreatedPhoneNumber
    {
        return new ServerMessageSessionCreatedPhoneNumber([
     ...
     * @return ServerMessageSessionCreatedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageSessionCreatedPhoneNumber
    {
        return new ServerMessageSessionCreatedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageSessionCreatedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageSessionCreatedPhoneNumber
    {
        return new ServerMessageSessionCreatedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageSessionCreatedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageSessionCreatedPhoneNumber
    {
        return new ServerMessageSessionCreatedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageSessionCreatedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageSessionCreatedPhoneNumber
    {
        return new ServerMessageSessionCreatedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
