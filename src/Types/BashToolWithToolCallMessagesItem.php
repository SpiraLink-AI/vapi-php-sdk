...
final class BashToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return BashToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): BashToolWithToolCallMessagesItem
    {
        return new BashToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return BashToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): BashToolWithToolCallMessagesItem
    {
        return new BashToolWithToolCallMessagesItem([
     ...
     * @return BashToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): BashToolWithToolCallMessagesItem
    {
        return new BashToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return BashToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): BashToolWithToolCallMessagesItem
    {
        return new BashToolWithToolCallMessagesItem([
