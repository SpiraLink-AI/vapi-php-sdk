...
final class CreateByoPhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return CreateByoPhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): CreateByoPhoneNumberDtoHooksItem
    {
        return new CreateByoPhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return CreateByoPhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): CreateByoPhoneNumberDtoHooksItem
    {
        return new CreateByoPhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
