...
final class PhoneNumberPaginatedResponseResultsItem extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return PhoneNumberPaginatedResponseResultsItem
     */
    public static function byoPhoneNumber(ByoPhoneNumber $byoPhoneNumber): PhoneNumberPaginatedResponseResultsItem
    {
        return new PhoneNumberPaginatedResponseResultsItem([
     ...
     * @return PhoneNumberPaginatedResponseResultsItem
     */
    public static function twilio(TwilioPhoneNumber $twilio): PhoneNumberPaginatedResponseResultsItem
    {
        return new PhoneNumberPaginatedResponseResultsItem([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumberPaginatedResponseResultsItem
     */
    public static function vonage(VonagePhoneNumber $vonage): PhoneNumberPaginatedResponseResultsItem
    {
        return new PhoneNumberPaginatedResponseResultsItem([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumberPaginatedResponseResultsItem
     */
    public static function vapi(VapiPhoneNumber $vapi): PhoneNumberPaginatedResponseResultsItem
    {
        return new PhoneNumberPaginatedResponseResultsItem([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumberPaginatedResponseResultsItem
     */
    public static function telnyx(TelnyxPhoneNumber $telnyx): PhoneNumberPaginatedResponseResultsItem
    {
        return new PhoneNumberPaginatedResponseResultsItem([
            'provider' => 'telnyx',
            'value' => $telnyx,
