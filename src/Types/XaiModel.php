...
final class XaiModel extends JsonSerializableType
{
    /**
     ...
     *
     * @var ?array<XaiModelToolsItem> $tools
     */
    #[JsonProperty('tools'), ArrayType([XaiModelToolsItem::class])]
    public ?array $tools;
    ...
    /**
     * @var value-of<XaiModelModel> $model This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
     */
    #[JsonProperty('model')]
    public string $model;
    ...
    /**
     * @param array{
     *   model: value-of<XaiModelModel>,
     *   messages?: ?array<OpenAiMessage>,
     *   tools?: ?array<XaiModelToolsItem>,
