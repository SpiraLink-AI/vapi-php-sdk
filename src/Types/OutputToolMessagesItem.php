...
final class OutputToolMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return OutputToolMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): OutputToolMessagesItem
    {
        return new OutputToolMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return OutputToolMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): OutputToolMessagesItem
    {
        return new OutputToolMessagesItem([
     ...
     * @return OutputToolMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): OutputToolMessagesItem
    {
        return new OutputToolMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return OutputToolMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): OutputToolMessagesItem
    {
        return new OutputToolMessagesItem([
