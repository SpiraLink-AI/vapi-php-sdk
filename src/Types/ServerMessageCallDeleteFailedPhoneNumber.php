 ...
 */
final class ServerMessageCallDeleteFailedPhoneNumber extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return ServerMessageCallDeleteFailedPhoneNumber
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): ServerMessageCallDeleteFailedPhoneNumber
    {
        return new ServerMessageCallDeleteFailedPhoneNumber([
     ...
     * @return ServerMessageCallDeleteFailedPhoneNumber
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): ServerMessageCallDeleteFailedPhoneNumber
    {
        return new ServerMessageCallDeleteFailedPhoneNumber([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return ServerMessageCallDeleteFailedPhoneNumber
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): ServerMessageCallDeleteFailedPhoneNumber
    {
        return new ServerMessageCallDeleteFailedPhoneNumber([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return ServerMessageCallDeleteFailedPhoneNumber
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): ServerMessageCallDeleteFailedPhoneNumber
    {
        return new ServerMessageCallDeleteFailedPhoneNumber([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return ServerMessageCallDeleteFailedPhoneNumber
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): ServerMessageCallDeleteFailedPhoneNumber
    {
        return new ServerMessageCallDeleteFailedPhoneNumber([
            'provider' => 'telnyx',
            'value' => $telnyx,
