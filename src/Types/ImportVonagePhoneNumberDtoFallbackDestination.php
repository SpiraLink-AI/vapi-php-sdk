 ...
 */
final class ImportVonagePhoneNumberDtoFallbackDestination extends JsonSerializableType
{
    /**
     * @var (
     *    'number'
     ...
     * @return ImportVonagePhoneNumberDtoFallbackDestination
     */
    public static function number(TransferDestinationNumber $number): ImportVonagePhoneNumberDtoFallbackDestination
    {
        return new ImportVonagePhoneNumberDtoFallbackDestination([
            'type' => 'number',
            'value' => $number,
        ]);
    }
     ...
     * @return ImportVonagePhoneNumberDtoFallbackDestination
     */
    public static function sip(TransferDestinationSip $sip): ImportVonagePhoneNumberDtoFallbackDestination
    {
        return new ImportVonagePhoneNumberDtoFallbackDestination([
            'type' => 'sip',
            'value' => $sip,
