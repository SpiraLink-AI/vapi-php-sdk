...
final class CreateVonagePhoneNumberDtoHooksItem extends JsonSerializableType
{
    /**
     * @var (
     *    'call.ringing'
     ...
     * @return CreateVonagePhoneNumberDtoHooksItem
     */
    public static function callRinging(PhoneNumberHookCallRinging $callRinging): CreateVonagePhoneNumberDtoHooksItem
    {
        return new CreateVonagePhoneNumberDtoHooksItem([
            'on' => 'call.ringing',
            'value' => $callRinging,
        ]);
    }
     ...
     * @return CreateVonagePhoneNumberDtoHooksItem
     */
    public static function callEnding(PhoneNumberHookCallEnding $callEnding): CreateVonagePhoneNumberDtoHooksItem
    {
        return new CreateVonagePhoneNumberDtoHooksItem([
            'on' => 'call.ending',
            'value' => $callEnding,
