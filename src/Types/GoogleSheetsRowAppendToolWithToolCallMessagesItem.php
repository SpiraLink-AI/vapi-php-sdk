...
final class GoogleSheetsRowAppendToolWithToolCallMessagesItem extends JsonSerializableType
{
    /**
     * @var (
     *    'request-start'
     ...
     * @return GoogleSheetsRowAppendToolWithToolCallMessagesItem
     */
    public static function requestStart(ToolMessageStart $requestStart): GoogleSheetsRowAppendToolWithToolCallMessagesItem
    {
        return new GoogleSheetsRowAppendToolWithToolCallMessagesItem([
            'type' => 'request-start',
            'value' => $requestStart,
        ]);
    }
     ...
     * @return GoogleSheetsRowAppendToolWithToolCallMessagesItem
     */
    public static function requestComplete(ToolMessageComplete $requestComplete): GoogleSheetsRowAppendToolWithToolCallMessagesItem
    {
        return new GoogleSheetsRowAppendToolWithToolCallMessagesItem([
     ...
     * @return GoogleSheetsRowAppendToolWithToolCallMessagesItem
     */
    public static function requestFailed(ToolMessageFailed $requestFailed): GoogleSheetsRowAppendToolWithToolCallMessagesItem
    {
        return new GoogleSheetsRowAppendToolWithToolCallMessagesItem([
            'type' => 'request-failed',
            'value' => $requestFailed,
     ...
     * @return GoogleSheetsRowAppendToolWithToolCallMessagesItem
     */
    public static function requestResponseDelayed(ToolMessageDelayed $requestResponseDelayed): GoogleSheetsRowAppendToolWithToolCallMessagesItem
    {
        return new GoogleSheetsRowAppendToolWithToolCallMessagesItem([
