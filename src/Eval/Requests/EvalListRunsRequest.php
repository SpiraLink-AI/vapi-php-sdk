...
use Vapi\Eval\Types\EvalListRunsRequestSortOrder;

final class EvalListRunsRequest extends JsonSerializableType
{
    /**
     * @var ?string $id
     */
    ...
    /**
     * @var ?value-of<EvalListRunsRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
     ...
     *   id?: ?string,
     *   page?: ?float,
     *   sortOrder?: ?value-of<EvalListRunsRequestSortOrder>,
     *   limit?: ?float,
