...
use Vapi\Eval\Types\EvalGetPaginatedRequestSortOrder;

final class EvalListRequest extends JsonSerializableType
{
    /**
     * @var ?string $id
     */
    ...
    /**
     * @var ?value-of<EvalGetPaginatedRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
     ...
     *   id?: ?string,
     *   page?: ?float,
     *   sortOrder?: ?value-of<EvalGetPaginatedRequestSortOrder>,
     *   limit?: ?float,
