...
use Vapi\Types\EvalRunTargetAssistant;
use Vapi\Types\EvalRunTargetSquad;

/**
 * This is the target that will be run against the eval
 */
final class CreateEvalRunDtoTarget extends JsonSerializableType
{
    /**
     * @var (
     *    'assistant'
     ...
     * @return CreateEvalRunDtoTarget
     */
    public static function assistant(EvalRunTargetAssistant $assistant): CreateEvalRunDtoTarget
    {
        return new CreateEvalRunDtoTarget([
            'type' => 'assistant',
            'value' => $assistant,
        ]);
    }
     ...
     * @return CreateEvalRunDtoTarget
     */
    public static function squad(EvalRunTargetSquad $squad): CreateEvalRunDtoTarget
    {
        return new CreateEvalRunDtoTarget([
            'type' => 'squad',
            'value' => $squad,
