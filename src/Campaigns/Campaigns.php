...
use Vapi\Campaigns\Requests\CampaignsListRequest;
...
final readonly class Campaigns
{
    /**
     * @var array{
     *   baseUrl?: string,
    ...
    /**
     * @param CampaignsListRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     */
    public function list(CampaignsListRequest $request = new CampaignsListRequest(), ?array $options = null): CampaignPaginatedResponse
    {
     ...
     * @throws VapiApiException
     */
    public function create(CreateCampaignDto $request, ?array $options = null): Campaign
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws VapiApiException
     */
    public function get(string $id, ?array $options = null): Campaign
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws VapiApiException
     */
    public function delete(string $id, ?array $options = null): Campaign
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws VapiApiException
     */
    public function update(string $id, UpdateCampaignDto $request = new UpdateCampaignDto(), ?array $options = null): Campaign
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
