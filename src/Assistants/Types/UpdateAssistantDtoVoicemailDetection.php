 ...
 */
final class UpdateAssistantDtoVoicemailDetection extends JsonSerializableType
{
    /**
     * @var (
     *    'google'
     ...
     * @return UpdateAssistantDtoVoicemailDetection
     */
    public static function google(GoogleVoicemailDetectionPlan $google): UpdateAssistantDtoVoicemailDetection
    {
        return new UpdateAssistantDtoVoicemailDetection([
            'provider' => 'google',
            'value' => $google,
        ]);
    }
     ...
     * @return UpdateAssistantDtoVoicemailDetection
     */
    public static function openai(OpenAiVoicemailDetectionPlan $openai): UpdateAssistantDtoVoicemailDetection
    {
        return new UpdateAssistantDtoVoicemailDetection([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateAssistantDtoVoicemailDetection
     */
    public static function twilio(TwilioVoicemailDetectionPlan $twilio): UpdateAssistantDtoVoicemailDetection
    {
        return new UpdateAssistantDtoVoicemailDetection([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return UpdateAssistantDtoVoicemailDetection
     */
    public static function vapi(VapiVoicemailDetectionPlan $vapi): UpdateAssistantDtoVoicemailDetection
    {
        return new UpdateAssistantDtoVoicemailDetection([
            'provider' => 'vapi',
            'value' => $vapi,
