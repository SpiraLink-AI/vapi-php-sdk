...
use Vapi\Types\DeepInfraModel;
use Vapi\Types\DeepSeekModel;
 ...
 */
final class UpdateAssistantDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'anthropic'
     ...
     */
    public static function anthropic(AnthropicModel $anthropic): UpdateAssistantDtoModel
    {
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function anyscale(AnyscaleModel $anyscale): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'anyscale',
            'value' => $anyscale,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function cerebras(CerebrasModel $cerebras): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'cerebras',
            'value' => $cerebras,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function customLlm(CustomLlmModel $customLlm): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function deepinfra(DeepInfraModel $deepinfra): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'deepinfra',
            'value' => $deepinfra,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function deepSeek(DeepSeekModel $deepSeek): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'deep-seek',
            'value' => $deepSeek,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function google(GoogleModel $google): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function groq(GroqModel $groq): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'groq',
            'value' => $groq,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function inflectionAi(InflectionAiModel $inflectionAi): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function openai(OpenAiModel $openai): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'openai',
            'value' => $openai,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function openrouter(OpenRouterModel $openrouter): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'openrouter',
            'value' => $openrouter,
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function perplexityAi(PerplexityAiModel $perplexityAi): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function togetherAi(TogetherAiModel $togetherAi): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
     ...
     * @return UpdateAssistantDtoModel
     */
    public static function xai(XaiModel $xai): UpdateAssistantDtoModel
    {
        return new UpdateAssistantDtoModel([
            'provider' => 'xai',
            'value' => $xai,
