 ...
 */
final class CreateStructuredOutputDtoModel extends JsonSerializableType
{
    /**
     * @var (
     *    'openai'
     ...
     * @return CreateStructuredOutputDtoModel
     */
    public static function openai(WorkflowOpenAiModel $openai): CreateStructuredOutputDtoModel
    {
        return new CreateStructuredOutputDtoModel([
            'provider' => 'openai',
            'value' => $openai,
        ]);
    }
     ...
     * @return CreateStructuredOutputDtoModel
     */
    public static function anthropic(WorkflowAnthropicModel $anthropic): CreateStructuredOutputDtoModel
    {
        return new CreateStructuredOutputDtoModel([
            'provider' => 'anthropic',
            'value' => $anthropic,
     ...
     * @return CreateStructuredOutputDtoModel
     */
    public static function google(WorkflowGoogleModel $google): CreateStructuredOutputDtoModel
    {
        return new CreateStructuredOutputDtoModel([
            'provider' => 'google',
            'value' => $google,
     ...
     * @return CreateStructuredOutputDtoModel
     */
    public static function customLlm(WorkflowCustomModel $customLlm): CreateStructuredOutputDtoModel
    {
        return new CreateStructuredOutputDtoModel([
            'provider' => 'custom-llm',
            'value' => $customLlm,
