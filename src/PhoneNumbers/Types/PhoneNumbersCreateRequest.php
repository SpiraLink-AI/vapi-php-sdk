...
use Vapi\Types\CreateByoPhoneNumberDto;
use Vapi\Types\CreateTelnyxPhoneNumberDto;
use Vapi\Types\CreateTwilioPhoneNumberDto;
use Vapi\Types\CreateVapiPhoneNumberDto;
use Vapi\Types\CreateVonagePhoneNumberDto;

final class PhoneNumbersCreateRequest extends JsonSerializableType
{
    /**
     * @var (
     *    'byo-phone-number'
     ...
     * @return PhoneNumbersCreateRequest
     */
    public static function byoPhoneNumber(CreateByoPhoneNumberDto $byoPhoneNumber): PhoneNumbersCreateRequest
    {
     ...
     * @return PhoneNumbersCreateRequest
     */
    public static function twilio(CreateTwilioPhoneNumberDto $twilio): PhoneNumbersCreateRequest
    {
        return new PhoneNumbersCreateRequest([
            'provider' => 'twilio',
            'value' => $twilio,
     ...
     * @return PhoneNumbersCreateRequest
     */
    public static function vonage(CreateVonagePhoneNumberDto $vonage): PhoneNumbersCreateRequest
    {
        return new PhoneNumbersCreateRequest([
            'provider' => 'vonage',
            'value' => $vonage,
     ...
     * @return PhoneNumbersCreateRequest
     */
    public static function vapi(CreateVapiPhoneNumberDto $vapi): PhoneNumbersCreateRequest
    {
        return new PhoneNumbersCreateRequest([
            'provider' => 'vapi',
            'value' => $vapi,
     ...
     * @return PhoneNumbersCreateRequest
     */
    public static function telnyx(CreateTelnyxPhoneNumberDto $telnyx): PhoneNumbersCreateRequest
    {
        return new PhoneNumbersCreateRequest([
            'provider' => 'telnyx',
            'value' => $telnyx,
