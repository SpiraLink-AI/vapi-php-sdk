...
use Vapi\PhoneNumbers\Types\PhoneNumbersListRequestSortOrder;

final class PhoneNumbersListRequest extends JsonSerializableType
{
    /**
     * @var ?string $search This will search phone numbers by name, number, or SIP URI (partial match, case-insensitive).
     */
    ...
    /**
     * @var ?value-of<PhoneNumbersListRequestSortOrder> $sortOrder This is the sort order for pagination. Defaults to 'DESC'.
     */
     ...
     *   search?: ?string,
     *   page?: ?float,
     *   sortOrder?: ?value-of<PhoneNumbersListRequestSortOrder>,
     *   limit?: ?float,
