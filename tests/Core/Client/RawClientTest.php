...
namespace Vapi\Tests\Core\Client;
...
use Vapi\Core\Client\RetryMiddleware;
use Vapi\Core\Json\JsonApiRequest;
use Vapi\Core\Json\JsonProperty;
use Vapi\Core\Json\JsonSerializableType;

final class JsonRequest extends JsonSerializableType
{
    /**
     * @var string
     */
...
final class RawClientTest extends TestCase
{
